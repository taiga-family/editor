...
var Mentions = (() => {
  ...
  }, inputs: { mentionSuggestions: [1, "mentionSuggestions"] }, outputs: { setMention: "setMention" }, decls: 5, vars: 0, consts: [["container", ""], ["button", ""], ["tuiOption", "", "type", "button"], ["tuiOption", "", "type", "button", 3, "click", "keydown.enter"], ["size", "s", 3, "tuiAvatar"]], template: function Mentions_Template(rf, ctx) {
    if (rf & 1) {
...
_Example.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _Example, selectors: [["ng-component"]], viewQuery: function Example_Query(rf, ctx) {
  ...
  provideTuiEditor(() => __async(_Example, null, function* () {
    return import("./chunk-M3DX2FDS.js").then(({ TuiMention }) => TuiMention);
  }))
...
//# sourceMappingURL=chunk-2P5RCWXU.js.map
