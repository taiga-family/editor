...
var Example = (() => {
  ...
  return _a = class {
    constructor() {
      this.wysiwyg = (__runInitializers(this, _instanceExtraInitializers), viewChild.required(TuiEditor));
    ...
    attach([file]) {
      ...
      this.wysiwyg().editor?.getOriginTiptapEditor()?.commands.insertContent(`<${tag} controls width="100%"><source src="${file?.link}" type="${file?.attrs?.type}"></${tag}><p><a href="${file?.link}" download="${file?.name}">Download ${file?.name}</a></p>`);
    }
  }, (() => {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(Example, { className: "Example", filePath: "projects/demo/src/app/pages/embed/html5/examples/1/index.ts", lineNumber: 102 });
})();
export {
  HttpMockUploader,
  __default as default
};
//# sourceMappingURL=chunk-UJCQPNO2.js.map
