...
_Example.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _Example, selectors: [["ng-component"]], viewQuery: function Example_Query(rf, ctx) {
  ...
  provideTuiEditor((injector) => __async(_Example, null, function* () {
    ...
    const { TableOfContents, getHierarchicalIndexes } = yield import("./chunk-INVXFW2F.js");
    return TableOfContents.configure({
      scrollParent: () => example.editor().rootEl.querySelector("tui-scrollbar") ?? win,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(Example, { className: "Example", filePath: "projects/demo/src/app/pages/table-of-contents/examples/1/index.ts", lineNumber: 42 });
})();
export {
  Example as default
};
//# sourceMappingURL=chunk-I3I2RUIH.js.map
