...
_Example.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _Example, selectors: [["ng-component"]], viewQuery: function Example_Query(rf, ctx) {
  ...
  provideTuiEditor({ textAlign: { types: ["heading", "paragraph"] } }, async () => import("./chunk-M23A7Z2C.js").then(({ Highlight }) => Highlight.configure({
    multicolor: true,
...
//# sourceMappingURL=chunk-CYLFEOFW.js.map
