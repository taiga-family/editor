...
_TuiEditorResizable.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _TuiEditorResizable, selectors: [["tui-editor-resizable"]], viewQuery: function TuiEditorResizable_Query(rf, ctx) {
  ...
  if (rf & 2) {
    \u0275\u0275styleProp("width", ctx.hostWidth)("height", ctx.hostHeight);
  }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(TuiEditorResizable, [{
    type: Component,
    args: [{ selector: "tui-editor-resizable", imports: [TuiResizable, TuiResizer], changeDetection: ChangeDetectionStrategy.OnPush, host: {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(TuiEditorResizable, { className: "TuiEditorResizable", filePath: "projects/editor/components/editor-resizable/editor-resizable.component.ts", lineNumber: 22 });
})();
...
//# sourceMappingURL=chunk-AJCAW3YX.js.map
