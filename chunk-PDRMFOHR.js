...
_Example.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _Example, selectors: [["ng-component"]], features: [\u0275\u0275ProvidersFeature([
  provideTuiEditor({
    ...
    return import("./chunk-TIMBSYEJ.js").then(({ FocusClasses }) => FocusClasses.configure({
      className: "has-focus",
      /**
       * @description:
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(Example, { className: "Example", filePath: "projects/demo/src/app/pages/focus/examples/1/index.ts", lineNumber: 54 });
})();
export {
  Example as default
};
//# sourceMappingURL=chunk-PDRMFOHR.js.map
