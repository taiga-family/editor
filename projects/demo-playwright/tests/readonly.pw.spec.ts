...
test.describe('Readonly and Disabled states', () => {
    test('check visible state on detail component', async ({page}) => {
        ...
        await expect.soft(editor.host).toHaveScreenshot('Readonly-01.png');
    });
    ...
    test('check readonly state on detail component', async ({page}) => {
        ...
        await editor.contenteditable();
        await expect.soft(editor.host).toHaveScreenshot('Readonly-02.png');
    });
    ...
    test('check disabled state on detail component', async ({page}) => {
        ...
        await editor.contenteditable();
        await expect.soft(editor.host).toHaveScreenshot('Readonly-03.png');
    });
    ...
    test('check visible controls on image', async ({page}) => {
        ...
        await expect.soft(editor.host).toHaveScreenshot('Readonly-04.png');
    });
    ...
    test('check disabled controls on image', async ({page}) => {
        ...
        await contenteditable.locator('tui-editor-resizable').hover({force: true});

        await expect.soft(editor.host).toHaveScreenshot('Readonly-05.png');
    });
});
