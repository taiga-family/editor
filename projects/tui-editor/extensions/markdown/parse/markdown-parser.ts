...
export class TuiEditorMarkdownParser {
    ...
    parse(content: unknown, {inline}: Record<string, any> = {}): string {
        if (typeof content === `string`) {
            this.editor.extensionManager.extensions.forEach(
                extension =>
    ...
    normalizeDOM(node: Element, {inline, content}: Record<string, any>): Element {
    ...
    normalizeBlocks(node: Element): void {
    ...
    normalizeInline(node: Element, content: string): void {
