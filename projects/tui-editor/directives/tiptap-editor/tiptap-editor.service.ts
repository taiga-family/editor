...
import type {TuiEditableImage} from '@tbank/tui-editor/extensions/image-editor';
...
import {TIPTAP_EDITOR} from '@tbank/tui-editor/tokens';
import {tuiGetMarkRange, tuiParseStyle} from '@tbank/tui-editor/utils';
