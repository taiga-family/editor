...
_TuiTextareaComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({
  ...
  hostBindings: function TuiTextareaComponent_HostBindings(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275listener("scroll.zoneless", function TuiTextareaComponent_scroll_zoneless_HostBindingHandler() {
        return ctx.onScroll();
      })("scroll.once", function TuiTextareaComponent_scroll_once_HostBindingHandler() {
        return ctx.onScroll();
      });
    }
    if (rf & 2) {
...
//# sourceMappingURL=chunk-DVI64H4K.js.map
