...
_Styles.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({
  ...
  exportAs: ["tui-cell-5.4.0"],
  decls: 0,
  vars: 0,
  template: function Styles_Template(rf, ctx) {
  },
  styles: ['[tuiCell]:where(*[data-tui-version="5.4.0"]){--t-pad: .125rem 1rem;--t-radius: var(--tui-radius-s);transition-property:background;transition-duration:var(--tui-duration, .3s);transition-timing-function:ease-in-out;-webkit-appearance:none;appearance:none;padding:0;border:0;background:none;font:inherit;line-height:inherit;text-decoration:none;position:relative;display:flex;align-items:center;text-align:start;box-sizing:content-box;isolation:isolate;color:var(--tui-text-primary);padding:var(--t-pad);min-block-size:var(--t-block-size);border-radius:var(--t-radius)}[tuiCell]:where(*[data-tui-version="5.4.0"]):is(button,label):not(:disabled):active{background:var(--tui-background-neutral-1)}[tuiCell]:where(*[data-tui-version="5.4.0"]):disabled,[tuiCell]:where(*[data-tui-version="5.4.0"])[data-state=disabled]{opacity:initial;pointer-events:none}[tuiCell]:where(*[data-tui-version="5.4.0"]):disabled>*:not([tuiTooltip]),[tuiCell]:where(*[data-tui-version="5.4.0"])[data-state=disabled]>*:not([tuiTooltip]){opacity:var(--tui-disabled-opacity)}[tuiCell]:where(*[data-tui-version="5.4.0"]):is(label):has(input:disabled){opacity:initial;pointer-events:none}[tuiCell]:where(*[data-tui-version="5.4.0"]):is(label):has(input:disabled)>*:not([tuiTooltip]){opacity:var(--tui-disabled-opacity)}[tuiCell]:where(*[data-tui-version="5.4.0"]) [tuiAccessories]{position:relative;display:flex;max-block-size:var(--t-block-size);align-items:center;align-self:stretch}[tuiCell]:where(*[data-tui-version="5.4.0"]) [tuiCellActions][tuiCellActions]{position:absolute;z-index:1;inset-inline-end:0;padding-inline-end:inherit;--t-group-mask: none;--t-group-mask-end: none;--t-group-mask-start: none}[tuiCell]:where(*[data-tui-version="5.4.0"]) [tuiCellActions][tuiCellActions]~*{transition-property:opacity;transition-duration:var(--tui-duration, .3s);transition-timing-function:ease-in-out}[tuiCell]:where(*[data-tui-version="5.4.0"]) [tuiCellActions][tuiCellActions] button,[tuiCell]:where(*[data-tui-version="5.4.0"]) [tuiCellActions][tuiCellActions] a{transition-property:opacity;transition-duration:var(--tui-duration, .3s);transition-timing-function:ease-in-out;opacity:0}[tuiCell]:where(*[data-tui-version="5.4.0"]) [tuiCellActions][tuiCellActions] button:focus-visible,[tuiCell]:where(*[data-tui-version="5.4.0"]) [tuiCellActions][tuiCellActions] a:focus-visible{opacity:1}[tuiCell]:where(*[data-tui-version="5.4.0"]) [tuiSubtitle]{display:flex;align-items:center;gap:.25rem;color:var(--tui-text-secondary)}[tuiCell]:where(*[data-tui-version="5.4.0"]) [tuiTitle]{flex-shrink:7;margin-inline-end:auto;align-items:normal;text-align:start}[tuiCell]:where(*[data-tui-version="5.4.0"]) [tuiTitle]~[tuiTitle]{flex-shrink:3;margin-inline-end:0;text-align:end;align-items:flex-end}[tuiCell]:where(*[data-tui-version="5.4.0"]) [tuiTitle]~[tuiTitle][tuiFade]{align-items:flex-start}[tuiCell]:where(*[data-tui-version="5.4.0"]) tui-badge-notification[data-size=xs]{position:absolute;top:50%;transform:translateY(-50%);inset-inline-start:-.625rem}[tuiCell]:where(*[data-tui-version="5.4.0"])[data-size=s]{--t-block-size: calc(var(--tui-height-s) - .125rem);--t-pad: .1875rem 1rem;gap:.5rem}[tuiCell]:where(*[data-tui-version="5.4.0"])[data-size=s][data-height=spacious]{--t-pad: .4375rem 1rem}[tuiCell]:where(*[data-tui-version="5.4.0"])[data-size=s][data-height=compact]{--t-block-size: calc(var(--tui-height-s) - .25rem);--t-pad: 0 1rem}[tuiCell]:where(*[data-tui-version="5.4.0"])[data-size=s] [tuiTitle]{max-block-size:100%;font:var(--tui-typography-ui-s);gap:0}[tuiCell]:where(*[data-tui-version="5.4.0"])[data-size=s] [tuiSubtitle]{font:var(--tui-typography-ui-2xs)}[tuiCell]:where(*[data-tui-version="5.4.0"])[data-size=s]>[tuiAvatar],[tuiCell]:where(*[data-tui-version="5.4.0"])[data-size=s]>tui-avatar-stack [tuiAvatar],[tuiCell]:where(*[data-tui-version="5.4.0"])[data-size=s]>[tuiAccessories] [tuiAvatar],[tuiCell]:where(*[data-tui-version="5.4.0"])[data-size=s]>[tuiAccessories] tui-avatar-stack [tuiAvatar]{--t-size: 1.5rem;font:var(--tui-typography-body-m);font-size:.5625rem}[tuiCell]:where(*[data-tui-version="5.4.0"])[data-size=m]{--t-block-size: calc(var(--tui-height-m) - .75rem);--t-pad: .375rem 1rem;gap:.75rem}[tuiCell]:where(*[data-tui-version="5.4.0"])[data-size=m][data-height=spacious]{--t-pad: 1rem}[tuiCell]:where(*[data-tui-version="5.4.0"])[data-size=m][data-height=compact]{--t-block-size: calc(var(--tui-height-m) - .5rem);--t-pad: 0 1rem}[tuiCell]:where(*[data-tui-version="5.4.0"])[data-size=m] [tuiTitle]{font:var(--tui-typography-ui-s);gap:.125rem}[tuiCell]:where(*[data-tui-version="5.4.0"])[data-size=m] [tuiSubtitle]{font:var(--tui-typography-ui-2xs)}[tuiCell]:where(*[data-tui-version="5.4.0"])[data-size=m]>[tuiAvatar],[tuiCell]:where(*[data-tui-version="5.4.0"])[data-size=m]>tui-avatar-stack [tuiAvatar],[tuiCell]:where(*[data-tui-version="5.4.0"])[data-size=m]>[tuiAccessories] [tuiAvatar],[tuiCell]:where(*[data-tui-version="5.4.0"])[data-size=m]>[tuiAccessories] tui-avatar-stack [tuiAvatar]{--t-size: 2rem;align-self:flex-start}[tuiCell]:where(*[data-tui-version="5.4.0"])[data-size=l]{--t-block-size: calc(var(--tui-height-l) - 1rem);--t-pad: .5rem 1rem;--t-radius: var(--tui-radius-l);gap:1rem}[tuiCell]:where(*[data-tui-version="5.4.0"])[data-size=l][data-height=spacious]{--t-pad: 1.25rem 1rem}[tuiCell]:where(*[data-tui-version="5.4.0"])[data-size=l][data-height=compact]{--t-block-size: calc(var(--tui-height-l) - 1rem);--t-pad: 0 1rem}[tuiCell]:where(*[data-tui-version="5.4.0"])[data-size=l]>[tuiAvatar],[tuiCell]:where(*[data-tui-version="5.4.0"])[data-size=l]>tui-avatar-stack [tuiAvatar],[tuiCell]:where(*[data-tui-version="5.4.0"])[data-size=l]>[tuiAccessories] [tuiAvatar],[tuiCell]:where(*[data-tui-version="5.4.0"])[data-size=l]>[tuiAccessories] tui-avatar-stack [tuiAvatar]{--t-size: 2.5rem;font:var(--tui-typography-body-m);font-weight:700;align-self:flex-start}[tuiCell]:where(*[data-tui-version="5.4.0"]):hover [tuiCellActions]~*{opacity:0}[tuiCell]:where(*[data-tui-version="5.4.0"]):hover [tuiCellActions] button,[tuiCell]:where(*[data-tui-version="5.4.0"]):hover [tuiCellActions] a,[tuiCell]:where(*[data-tui-version="5.4.0"]):hover [tuiCellActions] label{opacity:1}[tuiCell]:where(*[data-tui-version="5.4.0"]):focus-visible{outline:.125rem solid var(--tui-border-focus);outline-offset:-.125rem}@media (hover: hover) and (pointer: fine){a[tuiCell]:where(*[data-tui-version="5.4.0"]):hover:not(:disabled,[data-state=disabled]),button[tuiCell]:where(*[data-tui-version="5.4.0"]):hover:not(:disabled,[data-state=disabled]),label[tuiCell]:where(*[data-tui-version="5.4.0"]):hover:not(:disabled,[data-state=disabled]){background:var(--tui-background-neutral-1);cursor:pointer}label[tuiCell]:where(*[data-tui-version="5.4.0"]):hover:not(:has(input:disabled)){background:var(--tui-background-neutral-1);cursor:pointer}}\n'],
  encapsulation: 2,
  changeDetection: 0
});
var Styles = _Styles;
...
_TuiCell.\u0275dir = /* @__PURE__ */ \u0275\u0275defineDirective({
  ...
  hostAttrs: ["tuiCell", "", "data-tui-version", "5.4.0"],
  hostVars: 2,
  hostBindings: function TuiCell_HostBindings(rf, ctx) {
    if (rf & 2) {
      \u0275\u0275attribute("data-size", ctx.size() || ctx.options.size || "l")("data-height", ctx.height());
    }
  },
  inputs: {
    size: [1, "tuiCell", "size"],
...
_TuiDataListComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({
  ...
  hostAttrs: ["role", "listbox", "data-tui-version", "5.4.0"],
  hostVars: 2,
  ...
  styles: ['tui-data-list:where(*[data-tui-version="5.4.0"]){display:flex;flex-direction:column;padding:.25rem}tui-data-list:where(*[data-tui-version="5.4.0"]):focus-within [tuiOption]._with-dropdown:not(:focus){background:transparent}tui-data-list:where(*[data-tui-version="5.4.0"])[data-size=s] [tuiOption]{min-block-size:0;font:var(--tui-typography-ui-s);padding:.375rem}tui-data-list:where(*[data-tui-version="5.4.0"])[data-size=s] [tuiOption]:before,tui-data-list:where(*[data-tui-version="5.4.0"])[data-size=s] [tuiOption]:after{font-size:1rem}tui-data-list:where(*[data-tui-version="5.4.0"])[data-size=m] [tuiOption]{min-block-size:2.25rem;font:var(--tui-typography-ui-s);padding:.5rem .375rem}tui-data-list:where(*[data-tui-version="5.4.0"])[data-size=l]{gap:.125rem;padding:.5rem}tui-data-list:where(*[data-tui-version="5.4.0"])[data-size=l] [tuiOption]{font:var(--tui-typography-ui-m);padding-inline:.5rem}tui-data-list:where(*[data-tui-version="5.4.0"])[data-size=l] hr{block-size:1rem;border-inline-width:.5rem}tui-data-list:where(*[data-tui-version="5.4.0"]) [tuiOption]{transition-property:background;transition-duration:var(--tui-duration, .3s);transition-timing-function:ease-in-out;box-sizing:border-box;border-radius:var(--tui-radius-s);outline:none!important;cursor:pointer;word-break:break-word;text-transform:inherit}tui-data-list:where(*[data-tui-version="5.4.0"]) [tuiOption]:disabled{opacity:var(--tui-disabled-opacity);cursor:default}@media (hover: hover) and (pointer: fine){tui-data-list:where(*[data-tui-version="5.4.0"]) [tuiOption]:hover:not(:disabled){background:var(--tui-background-neutral-1)}}tui-data-list:where(*[data-tui-version="5.4.0"]) [tuiOption]:active:not(:disabled),tui-data-list:where(*[data-tui-version="5.4.0"]) [tuiOption]:focus-within,tui-data-list:where(*[data-tui-version="5.4.0"]) [tuiOption]._with-dropdown{background:var(--tui-background-neutral-1)}tui-data-list:where(*[data-tui-version="5.4.0"]) [tuiOption]:after{margin-inline-start:auto}tui-data-list:where(*[data-tui-version="5.4.0"])>.t-empty{pointer-events:none;color:var(--tui-text-tertiary)}tui-data-list:where(*[data-tui-version="5.4.0"]) hr{position:relative;margin:0;block-size:.75rem;border:.375rem solid transparent;border-block:0}tui-data-list:where(*[data-tui-version="5.4.0"]) hr+hr,tui-data-list:where(*[data-tui-version="5.4.0"]) hr:first-child,tui-data-list:where(*[data-tui-version="5.4.0"]) hr:last-child{display:none}tui-data-list:where(*[data-tui-version="5.4.0"]) hr:before{position:absolute;inset:50% auto auto 50%;transform:translate(-50%,-50%);content:"";block-size:1px;inline-size:100%;background:var(--tui-border-normal)}tui-opt-group:where(*[data-tui-version="5.4.0"]){position:relative;display:flex;font-weight:700!important;gap:inherit;color:var(--tui-text-primary);flex-direction:column}tui-data-list[data-size=s] tui-opt-group:where(*[data-tui-version="5.4.0"]){font:var(--tui-typography-body-s)}tui-data-list[data-size=s] tui-opt-group:where(*[data-tui-version="5.4.0"]):before{padding:.1875rem .375rem}tui-data-list[data-size=m] tui-opt-group:where(*[data-tui-version="5.4.0"]){font:var(--tui-typography-ui-m)}tui-data-list[data-size=m] tui-opt-group:where(*[data-tui-version="5.4.0"]):before{padding:.375rem}tui-data-list[data-size=l] tui-opt-group:where(*[data-tui-version="5.4.0"]){font:var(--tui-typography-ui-l)}tui-data-list[data-size=l] tui-opt-group:where(*[data-tui-version="5.4.0"]):before{padding:.5rem}tui-opt-group:where(*[data-tui-version="5.4.0"]):empty:before,tui-opt-group:where(*[data-tui-version="5.4.0"])[data-label=""]:before{display:none}tui-opt-group:where(*[data-tui-version="5.4.0"]):before{content:attr(data-label);word-break:break-word}tui-sheet-dialog tui-opt-group:where(*[data-tui-version="5.4.0"]):before{font:var(--tui-typography-heading-h6);padding:.5rem 0!important}\n'],
  encapsulation: 2,
  changeDetection: 0
});
...
_TuiOptGroup.\u0275dir = /* @__PURE__ */ \u0275\u0275defineDirective({
  ...
  hostAttrs: ["role", "group", "data-tui-version", "5.4.0"],
  hostVars: 1,
...
_Styles2.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({
  type: _Styles2,
  selectors: [["ng-component"]],
  exportAs: ["tui-label-5.4.0"],
  decls: 0,
  vars: 0,
  template: function Styles_Template(rf, ctx) {
  },
  styles: ['[tuiLabel]:where(*[data-tui-version="5.4.0"]){display:flex;gap:.25rem;flex-direction:column;font:var(--tui-typography-body-s);color:var(--tui-text-primary)}[tuiLabel]:where(*[data-tui-version="5.4.0"]):not([data-orientation=vertical]){flex-direction:row;inline-size:fit-content;font:var(--tui-typography-body-m)}[tuiLabel]:where(*[data-tui-version="5.4.0"]) input[type=checkbox],[tuiLabel]:where(*[data-tui-version="5.4.0"]) input[type=radio]{margin-inline-end:.5rem}[tuiLabel]:where(*[data-tui-version="5.4.0"]) input[type=checkbox][data-size=s],[tuiLabel]:where(*[data-tui-version="5.4.0"]) input[type=radio][data-size=s]{margin-inline-end:.25rem;margin-block-start:.125rem}[tuiLabel]:where(*[data-tui-version="5.4.0"]) small{font:var(--tui-typography-body-s)}[tuiLabel]:where(*[data-tui-version="5.4.0"]) [tuiTitle]{margin-block-start:.125rem}[tuiLabel]:where(*[data-tui-version="5.4.0"]) [tuiSubtitle]{color:var(--tui-text-secondary)}\n'],
  encapsulation: 2,
  changeDetection: 0
});
...
_TuiButtonX.\u0275dir = /* @__PURE__ */ \u0275\u0275defineDirective({
  ...
  hostAttrs: ["tuiIconButton", "", "type", "button", "tabindex", "-1"],
  hostVars: 2,
...
_TuiTextfieldComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({
  ...
  hostBindings: function TuiTextfieldComponent_HostBindings(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275listener("animationstart", function TuiTextfieldComponent_animationstart_HostBindingHandler() {
        return 0;
      })("animationcancel", function TuiTextfieldComponent_animationcancel_HostBindingHandler() {
        return 0;
    ...
    if (rf & 2) {
      ...
      \u0275\u0275classProp("_with-label", ctx.hasLabel)("_with-template", ctx.content() && ((tmp_2_0 = ctx.control()) == null ? null : tmp_2_0.value) != null)("_disabled", ctx.disabled);
    }
  },
  inputs: {
    content: [1, "content"],
...
_TuiInputDirective.\u0275dir = /* @__PURE__ */ \u0275\u0275defineDirective({
  ...
  hostBindings: function TuiInputDirective_HostBindings(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275listener("input", function TuiInputDirective_input_HostBindingHandler() {
        return 0;
      })("focusin", function TuiInputDirective_focusin_HostBindingHandler() {
        return 0;
...
_TuiRadioComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({
  ...
  styles: ['[tuiRadio]:where(*[data-tui-version="5.4.0"]){--t-size: 1.5rem;transition-property:background,box-shadow;transition-duration:var(--tui-duration, .3s);transition-timing-function:ease-in-out;inline-size:var(--t-size);block-size:var(--t-size);cursor:pointer;margin:0;flex-shrink:0;border-radius:100%;color:var(--tui-text-primary-on-accent-1)}[tuiRadio]:where(*[data-tui-version="5.4.0"]):disabled._readonly._readonly{opacity:1}[tuiRadio]:where(*[data-tui-version="5.4.0"]):before{position:absolute;inset-block-start:0;inset-inline-start:0;inset-block-end:0;inset-inline-end:0;content:"";margin:auto;border-radius:100%;background:currentColor;transform:scale(0);transition-property:transform}[tuiRadio]:where(*[data-tui-version="5.4.0"]):checked:before{transform:scale(.5)}[tuiRadio]:where(*[data-tui-version="5.4.0"])[data-size=s]{--t-size: 1rem}[tuiRadio]:where(*[data-tui-version="5.4.0"]):invalid:not([data-mode]),[tuiRadio]:where(*[data-tui-version="5.4.0"])[data-mode~=invalid]{color:#fff}\n'],
  encapsulation: 2,
  changeDetection: 0
});
...
var Styles$1 = (_a2 = class {
  ...
  type: _a2,
  selectors: [["ng-component"]],
  exportAs: ["tui-avatar-5.4.0"],
  decls: 0,
  vars: 0,
  template: function Styles_Template(rf, ctx) {
  },
  styles: ['[tuiAvatar]:where(*[data-tui-version="5.4.0"]){--t-size: var(--tui-height-l);--t-radius: .75rem;--t-corner-offset: calc((var(--t-radius) * 1.4142 - var(--t-radius)) * 1 / 1.4142);position:relative;display:inline-flex;flex-shrink:0;inline-size:var(--t-size);block-size:var(--t-size);align-items:center;justify-content:center;white-space:nowrap;border-radius:var(--t-radius);border:none;background:var(--tui-background-neutral-1);color:var(--tui-text-secondary);vertical-align:middle;box-sizing:border-box;padding:.25rem;font:var(--tui-typography-body-l);font-weight:700;opacity:.999}[tuiAvatar]:where(*[data-tui-version="5.4.0"]):is(a,button,select,textarea,input,label,.tui-interactive):not(:disabled){cursor:pointer}[tuiAvatar]:where(*[data-tui-version="5.4.0"]):before{inline-size:auto;block-size:auto}[tuiAvatar]:where(*[data-tui-version="5.4.0"]):not(._initials):before{position:absolute;inset:0;font-size:calc(var(--t-size) * .6)}[tuiAvatar]:where(*[data-tui-version="5.4.0"])[data-size=xs]{--t-size: var(--tui-height-xs);--t-radius: .5rem;font:var(--tui-typography-ui-2xs);font-size:.5625rem}[tuiAvatar]:where(*[data-tui-version="5.4.0"])[data-size=xs]._initials:before{font:var(--tui-typography-ui-2xs);font-weight:700}[tuiAvatar]:where(*[data-tui-version="5.4.0"])[data-size=s]{--t-size: var(--tui-height-s);--t-radius: .5rem;font:var(--tui-typography-ui-2xs);font-weight:700}[tuiAvatar]:where(*[data-tui-version="5.4.0"])[data-size=s]._initials:before{font:var(--tui-typography-body-s);font-weight:700}[tuiAvatar]:where(*[data-tui-version="5.4.0"])[data-size=m]{--t-size: calc(var(--tui-height-m) - .25rem);--t-radius: .75rem;font:var(--tui-typography-ui-m);font-weight:700}[tuiAvatar]:where(*[data-tui-version="5.4.0"])[data-size=m]._initials:before{font:var(--tui-typography-body-m);font-weight:700}[tuiAvatar]:where(*[data-tui-version="5.4.0"])[data-size=xl]{--t-size: 5rem;--t-radius: .75rem;font:var(--tui-typography-heading-h4)}[tuiAvatar]:where(*[data-tui-version="5.4.0"])[data-size=xl]._initials:before{font:var(--tui-typography-heading-h3)}[tuiAvatar]:where(*[data-tui-version="5.4.0"])[data-size=xxl]{--t-size: 6rem;--t-radius: 1rem;font:var(--tui-typography-heading-h3)}[tuiAvatar]:where(*[data-tui-version="5.4.0"])[data-size=xxl]._initials:before{font:var(--tui-typography-heading-h3)}[tuiAvatar]:where(*[data-tui-version="5.4.0"])[data-size=xxxl]{--t-size: 8rem;--t-radius: 1.25rem;font:var(--tui-typography-heading-h3)}[tuiAvatar]:where(*[data-tui-version="5.4.0"])[data-size=xxxl]._initials:before{font:var(--tui-typography-heading-h2)}[tuiAvatar]:where(*[data-tui-version="5.4.0"]):not([data-shape=square]){--t-radius: calc(var(--t-size) / 2)}[tuiAvatar]:where(*[data-tui-version="5.4.0"])._initials:before{content:attr(data-icon-start);mask:none;background:none;font:var(--tui-typography-heading-h6)}[tuiAvatar]:where(*[data-tui-version="5.4.0"])._badge{mask:radial-gradient(circle at calc(max(var(--tui-inline),0) * 100% - var(--tui-inline) * var(--t-corner-offset)) calc(100% - var(--t-corner-offset)),black .23rem,transparent .25rem,transparent .375rem,black .39rem);mask-clip:no-clip}[tuiAvatar]:where(*[data-tui-version="5.4.0"])._badge:after{content:"";position:absolute;display:block;inset-block-start:calc(100% - var(--t-corner-offset));inset-inline-start:calc(100% - var(--t-corner-offset));inline-size:.55rem;block-size:.55rem;border-radius:100%;background:var(--t-badge);transform:translate3d(calc(var(--tui-inline) * -50%),-50%,0)}[tuiAvatar]:where(*[data-tui-version="5.4.0"])._fallback img,[tuiAvatar]:where(*[data-tui-version="5.4.0"])._fallback video{display:none}[tuiAvatar]:where(*[data-tui-version="5.4.0"]) img,[tuiAvatar]:where(*[data-tui-version="5.4.0"]) video,[tuiAvatar]:where(*[data-tui-version="5.4.0"]) picture{position:absolute;inset-block-start:0;inset-inline-start:0;inline-size:100%;block-size:100%;object-fit:cover;box-sizing:border-box;border-radius:inherit}[tuiAvatar]:where(*[data-tui-version="5.4.0"]):has(img,video):not(._fallback){background:none}\n'],
  encapsulation: 2,
  changeDetection: 0
}), _a2);
(() => {
...
_TuiAvatar.\u0275dir = /* @__PURE__ */ \u0275\u0275defineDirective({
  ...
  hostBindings: function TuiAvatar_HostBindings(rf, ctx) {
    ...
    if (rf & 2) {
      let tmp_3_0;
      \u0275\u0275attribute("data-size", ctx.size())("data-shape", ctx.round() ? "round" : "square");
      \u0275\u0275styleProp("--t-badge", ctx.badge());
      \u0275\u0275classProp("_initials", ((tmp_3_0 = ctx.icons.iconStart()) == null ? null : tmp_3_0.length) < 3)("_fallback", ctx.fallback())("_badge", ctx.badge());
    }
  },
  inputs: {
    size: [1, "size"],
...
_TuiAvatarLabeled.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({
  ...
  styles: ['tui-avatar-labeled:where(*[data-tui-version="5.4.0"]){display:flex;inline-size:3.5rem;box-sizing:content-box;flex-direction:column;text-align:center;align-items:center;font:var(--tui-typography-ui-xs);padding:0 .5rem;white-space:nowrap}tui-avatar-labeled:where(*[data-tui-version="5.4.0"]) [tuiAvatar]{margin-block-end:.375rem}tui-avatar-labeled:where(*[data-tui-version="5.4.0"]) [tuiFade]{inline-size:calc(100% + 1rem)}\n'],
  encapsulation: 2,
  changeDetection: 0
});
...
_Styles4.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({
  type: _Styles4,
  selectors: [["ng-component"]],
  exportAs: ["tui-avatar-outline-5.4.0"],
  decls: 0,
  vars: 0,
  template: function Styles_Template1(rf, ctx) {
  },
  styles: ['[tuiAvatarOutline]:where(*[data-tui-version="5.4.0"]){--t-outline: .1875rem;--t-gap: .125rem}[tuiAvatarOutline]:where(*[data-tui-version="5.4.0"])[data-size=xs],[tuiAvatarOutline]:where(*[data-tui-version="5.4.0"])[data-size=s],[tuiAvatarOutline]:where(*[data-tui-version="5.4.0"])[data-size=m]{--t-outline: .125rem;--t-gap: .0625rem}[tuiAvatarOutline]:where(*[data-tui-version="5.4.0"])._outline{mask:radial-gradient(closest-side,#000,#000 calc(100% - var(--t-gap) - var(--t-outline) - .5px),transparent calc(100% - var(--t-gap) - var(--t-outline)),transparent calc(100% - var(--t-outline) - .5px),#000 calc(100% - var(--t-outline)))}[tuiAvatarOutline]:where(*[data-tui-version="5.4.0"])._outline:after{content:"";position:absolute;inset-block-start:0;inset-inline-start:0;inline-size:100%;block-size:100%;background:var(--t-fill);mask:radial-gradient(closest-side,transparent,transparent calc(100% - var(--t-outline) - .5px),#000 calc(100% - var(--t-outline)))}\n'],
  encapsulation: 2,
  changeDetection: 0
});
...
_TuiAvatarStack.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({
  ...
  styles: ['tui-avatar-stack:where(*[data-tui-version="5.4.0"]){display:flex;--t-gap: .125rem}tui-avatar-stack:where(*[data-tui-version="5.4.0"]) [tuiAvatar]{--t-offset: 2.5rem}tui-avatar-stack:where(*[data-tui-version="5.4.0"]) [tuiAvatar][data-size=xl]{--t-offset: 2.125rem}tui-avatar-stack:where(*[data-tui-version="5.4.0"]) [tuiAvatar][data-size=l]{--t-offset: 1.5rem}tui-avatar-stack:where(*[data-tui-version="5.4.0"]) [tuiAvatar][data-size=m]{--t-offset: .75rem}tui-avatar-stack:where(*[data-tui-version="5.4.0"]) [tuiAvatar][data-size=s]{--t-offset: .575rem}tui-avatar-stack:where(*[data-tui-version="5.4.0"]) [tuiAvatar][data-size=xs]{--t-offset: .375rem}tui-avatar-stack:where(*[data-tui-version="5.4.0"]) [tuiAvatar]._round{-webkit-mask-image:radial-gradient(circle at calc(50% - calc(var(--tui-inline) * (var(--t-size) - var(--t-offset)))) 50%,transparent calc(var(--t-radius) + var(--t-gap)),#000 calc(var(--t-radius) + var(--t-gap) + .2px));mask-image:radial-gradient(circle at calc(50% - calc(var(--tui-inline) * (var(--t-size) - var(--t-offset)))) 50%,transparent calc(var(--t-radius) + var(--t-gap)),#000 calc(var(--t-radius) + var(--t-gap) + .2px))}tui-avatar-stack:where(*[data-tui-version="5.4.0"])[data-direction=end] [tuiAvatar]._round{--tui-inline: -1}[dir=rtl] tui-avatar-stack:where(*[data-tui-version="5.4.0"])[data-direction=end] [tuiAvatar]._round{--tui-inline: 1}tui-avatar-stack:where(*[data-tui-version="5.4.0"])[data-direction=end] [tuiAvatar]._round:last-child{-webkit-mask-image:none;mask-image:none}tui-avatar-stack:where(*[data-tui-version="5.4.0"])[data-direction=start] [tuiAvatar]._round:first-child{-webkit-mask-image:none;mask-image:none}tui-avatar-stack:where(*[data-tui-version="5.4.0"])[data-direction=start] [tuiAvatar]:not(._round):not(:first-child),[dir=rtl] tui-avatar-stack:where(*[data-tui-version="5.4.0"])[data-direction=end] [tuiAvatar]:not(._round):not(:last-child){-webkit-mask-image:radial-gradient(circle at 0% 100%,transparent calc(var(--t-radius) + var(--t-gap)),#000 calc(var(--t-radius) + var(--t-gap) + .2px)),radial-gradient(circle at 0% 0%,transparent calc(var(--t-radius) + var(--t-gap)),#000 calc(var(--t-radius) + var(--t-gap) + .2px)),linear-gradient(to right,transparent calc(var(--t-offset) + var(--t-gap)),#000 calc(var(--t-offset) + var(--t-gap)));mask-image:radial-gradient(circle at 0% 100%,transparent calc(var(--t-radius) + var(--t-gap)),#000 calc(var(--t-radius) + var(--t-gap) + .2px)),radial-gradient(circle at 0% 0%,transparent calc(var(--t-radius) + var(--t-gap)),#000 calc(var(--t-radius) + var(--t-gap) + .2px)),linear-gradient(to right,transparent calc(var(--t-offset) + var(--t-gap)),#000 calc(var(--t-offset) + var(--t-gap)));-webkit-mask-position:calc(var(--t-offset) - var(--t-radius)) calc(-1 * (var(--t-size) - var(--t-radius))),calc(var(--t-offset) - var(--t-radius)) calc(var(--t-size) - var(--t-radius)),bottom;mask-position:calc(var(--t-offset) - var(--t-radius)) calc(-1 * (var(--t-size) - var(--t-radius))),calc(var(--t-offset) - var(--t-radius)) calc(var(--t-size) - var(--t-radius)),bottom}tui-avatar-stack:where(*[data-tui-version="5.4.0"])[data-direction=end] [tuiAvatar]:not(._round):not(:last-child),[dir=rtl] tui-avatar-stack:where(*[data-tui-version="5.4.0"])[data-direction=start] [tuiAvatar]:not(._round):not(:first-child){-webkit-mask-image:radial-gradient(circle at 150% 100%,transparent calc(var(--t-radius) + var(--t-gap)),#000 calc(var(--t-radius) + var(--t-gap) + .2px)),radial-gradient(circle at 150% 0%,transparent calc(var(--t-radius) + var(--t-gap)),#000 calc(var(--t-radius) + var(--t-gap) + .2px)),linear-gradient(to left,transparent calc(var(--t-offset) + var(--t-gap)),#000 calc(var(--t-offset) + var(--t-gap)));mask-image:radial-gradient(circle at 150% 100%,transparent calc(var(--t-radius) + var(--t-gap)),#000 calc(var(--t-radius) + var(--t-gap) + .2px)),radial-gradient(circle at 150% 0%,transparent calc(var(--t-radius) + var(--t-gap)),#000 calc(var(--t-radius) + var(--t-gap) + .2px)),linear-gradient(to left,transparent calc(var(--t-offset) + var(--t-gap)),#000 calc(var(--t-offset) + var(--t-gap)));-webkit-mask-position:calc((var(--t-offset) - var(--t-size) + var(--t-radius) / 2 + var(--t-gap) + 1px) * -1) calc(-1 * var(--t-gap)),calc((var(--t-offset) - var(--t-size) + var(--t-radius) / 2 + var(--t-gap) + 1px) * -1) calc(100% + var(--t-gap)),bottom;mask-position:calc((var(--t-offset) - var(--t-size) + var(--t-radius) / 2 + var(--t-gap) + 1px) * -1) calc(-1 * var(--t-gap)),calc((var(--t-offset) - var(--t-size) + var(--t-radius) / 2 + var(--t-gap) + 1px) * -1) calc(100% + var(--t-gap)),bottom}tui-avatar-stack:where(*[data-tui-version="5.4.0"]) [tuiAvatar]:not(._round){-webkit-mask-repeat:no-repeat;mask-repeat:no-repeat}[dir=rtl] tui-avatar-stack:where(*[data-tui-version="5.4.0"])[data-direction=start] [tuiAvatar]:not(._round),tui-avatar-stack:where(*[data-tui-version="5.4.0"])[data-direction=end] [tuiAvatar]:not(._round){-webkit-mask-size:calc(var(--t-radius) + var(--t-gap)) calc(var(--t-radius) + var(--t-gap)),calc(var(--t-radius) + var(--t-gap)) calc(var(--t-radius) + var(--t-gap)),100%;mask-size:calc(var(--t-radius) + var(--t-gap)) calc(var(--t-radius) + var(--t-gap)),calc(var(--t-radius) + var(--t-gap)) calc(var(--t-radius) + var(--t-gap)),100%}[dir=rtl] tui-avatar-stack:where(*[data-tui-version="5.4.0"])[data-direction=end] [tuiAvatar]:not(._round){-webkit-mask-size:unset;mask-size:unset}tui-avatar-stack:where(*[data-tui-version="5.4.0"]) [tuiAvatar]:not(:last-child){margin-inline-end:calc(-1 * var(--t-offset))}\n'],
  encapsulation: 2,
  changeDetection: 0
});
...
_TuiSwitch.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({
  ...
  styles: ['[tuiSwitch]:where(*[data-tui-version="5.4.0"]){transition-property:background,box-shadow;transition-duration:var(--tui-duration, .3s);transition-timing-function:ease-in-out;display:inline-block;inline-size:3rem;block-size:1.5rem;border-radius:2rem;overflow:hidden;cursor:pointer;margin:0;flex-shrink:0;color:#fff!important}[tuiSwitch]:where(*[data-tui-version="5.4.0"])[data-size=s]{block-size:1rem;inline-size:2rem}[tuiSwitch]:where(*[data-tui-version="5.4.0"])[data-size=s]:before{inline-size:1rem;transform:translate(calc(var(--tui-inline) * -1rem));font-size:.75rem}[tuiSwitch]:where(*[data-tui-version="5.4.0"])[data-size=s]:after{inline-size:1rem;box-shadow:calc(var(--tui-inline) * -2.625rem) 0 0 .5rem var(--tui-background-base);outline-width:.167rem;transform:scale(.375)}[tuiSwitch]:where(*[data-tui-version="5.4.0"])[data-size=s]:checked:after{transform:scale(.375) translate(calc(var(--tui-inline) * 2.625rem))}[tuiSwitch]:where(*[data-tui-version="5.4.0"]):checked:before{transform:none}[tuiSwitch]:where(*[data-tui-version="5.4.0"]):checked:after{transform:scale(.33333) translate(calc(var(--tui-inline) * 4.5rem))}[tuiSwitch]:where(*[data-tui-version="5.4.0"]):disabled._readonly._readonly{opacity:1}[tuiSwitch]:where(*[data-tui-version="5.4.0"]):before,[tuiSwitch]:where(*[data-tui-version="5.4.0"]):after{position:absolute;block-size:100%;inline-size:1.5rem;transition-property:transform;zoom:1}[tuiSwitch]:where(*[data-tui-version="5.4.0"]):before{inset-inline-start:.125rem;font-size:1rem;transform:translate(calc(var(--tui-inline) * -1.5rem))}[tuiSwitch]:where(*[data-tui-version="5.4.0"]):after{display:block;inset-inline-end:0;border-radius:100%;background:none;transform:scale(.33333);box-shadow:calc(var(--tui-inline) * -4.5rem) 0 0 .75rem var(--tui-background-base);outline:.375rem solid var(--tui-background-neutral-2-pressed)}[tuiSwitch]:where(*[data-tui-version="5.4.0"]):not([data-icon-start]):after{outline-offset:20rem}[tuiSwitch]:where(*[data-tui-version="5.4.0"]):invalid:not([data-mode]),[tuiSwitch]:where(*[data-tui-version="5.4.0"])[data-mode~=invalid]{color:#fff}\n'],
  encapsulation: 2,
  changeDetection: 0
});
...
_TuiCheckbox.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({
  ...
  styles: [`[tuiCheckbox]:where(*[data-tui-version="5.4.0"]){--t-size: 1.5rem;--t-radius: var(--tui-radius-s);inline-size:var(--t-size);block-size:var(--t-size);border-radius:var(--t-radius);cursor:pointer;margin:0;flex-shrink:0}[tuiCheckbox]:where(*[data-tui-version="5.4.0"]):before{position:absolute;block-size:100%;inline-size:100%;font-size:1rem;-webkit-mask-image:url('data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg"></svg>');mask-image:url('data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg"></svg>');transform:scale(0);transition:transform var(--tui-duration) ease-in-out,mask 0s var(--tui-duration) ease-in-out}[tuiCheckbox]:where(*[data-tui-version="5.4.0"]):after{display:none}[tuiCheckbox]:where(*[data-tui-version="5.4.0"]):disabled._readonly._readonly{opacity:1;pointer-events:none}[tuiCheckbox]:where(*[data-tui-version="5.4.0"]):checked:before,[tuiCheckbox]:where(*[data-tui-version="5.4.0"]):indeterminate:before{-webkit-mask-image:var(--t-icon-start);mask-image:var(--t-icon-start);transform:scale(1);transition:transform var(--tui-duration) ease-in-out,mask 0s ease-in-out;transition-duration:inherit}[tuiCheckbox]:where(*[data-tui-version="5.4.0"]):indeterminate:before{-webkit-mask-image:var(--t-icon-end);mask-image:var(--t-icon-end)}[tuiCheckbox]:where(*[data-tui-version="5.4.0"])[data-size=s]{--t-size: 1rem;--t-radius: var(--tui-radius-xs)}[tuiCheckbox]:where(*[data-tui-version="5.4.0"])[data-size=s]:before{font-size:.875rem}[tuiCheckbox]:where(*[data-tui-version="5.4.0"]):invalid:not([data-mode]),[tuiCheckbox]:where(*[data-tui-version="5.4.0"])[data-mode~=invalid]{color:#fff}
`],
  encapsulation: 2,
  changeDetection: 0
});
...
_Styles5.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({
  type: _Styles5,
  selectors: [["ng-component"]],
  exportAs: ["tui-chip-5.4.0"],
  decls: 0,
  vars: 0,
  template: function Styles_Template(rf, ctx) {
  },
  styles: ['[tuiChip]:where(*[data-tui-version="5.4.0"]){--t-gap: .125rem;--t-margin: -.125rem;--t-icon-size: 1rem;--t-padding: 0 .625rem;--t-size: var(--tui-height-s);-webkit-appearance:none;appearance:none;padding:0;border:0;background:none;font:inherit;line-height:inherit;text-decoration:none;position:relative;display:inline-flex;align-items:center;flex-shrink:0;box-sizing:border-box;white-space:nowrap;overflow:hidden;vertical-align:middle;gap:calc(var(--t-gap, 0rem) - 2 * var(--t-margin, 0rem));font:var(--tui-typography-body-s);border-radius:var(--tui-radius-m);padding:var(--t-padding);block-size:var(--t-size);inline-size:fit-content;max-inline-size:100%;isolation:isolate}[tuiChip]:where(*[data-tui-version="5.4.0"])>img,[tuiChip]:where(*[data-tui-version="5.4.0"])>tui-icon,[tuiChip]:where(*[data-tui-version="5.4.0"])>[tuiAvatar],[tuiChip]:where(*[data-tui-version="5.4.0"])>tui-badge,[tuiChip]:where(*[data-tui-version="5.4.0"])>[tuiBadge],[tuiChip]:where(*[data-tui-version="5.4.0"])>[tuiRadio],[tuiChip]:where(*[data-tui-version="5.4.0"])>[tuiSwitch],[tuiChip]:where(*[data-tui-version="5.4.0"])>[tuiCheckbox],[tuiChip]:where(*[data-tui-version="5.4.0"])[tuiIcons]:before,[tuiChip]:where(*[data-tui-version="5.4.0"])[tuiIcons]:after{margin:var(--t-margin)}[tuiChip]:where(*[data-tui-version="5.4.0"]):is(a,button,select,textarea,input,label,.tui-interactive):not(:disabled){cursor:pointer}[tuiChip]:where(*[data-tui-version="5.4.0"])>tui-icon,[tuiChip]:where(*[data-tui-version="5.4.0"])[tuiIcons]:before,[tuiChip]:where(*[data-tui-version="5.4.0"])[tuiIcons]:after{font-size:var(--t-icon-size)!important}[tuiChip]:where(*[data-tui-version="5.4.0"])>[tuiIconButton]{margin:-.375rem}[tuiChip]:where(*[data-tui-version="5.4.0"])>[tuiBadge]{margin-inline-end:0}[tuiChip]:where(*[data-tui-version="5.4.0"])[data-size=xxs]{--t-gap: 0rem;--t-padding: 0 .25rem;--t-size: 1rem;--t-icon-size: .75rem;font:var(--tui-typography-body-xs);border-radius:var(--tui-radius-xs)}[tuiChip]:where(*[data-tui-version="5.4.0"])[data-size=xxs]>[tuiIconButton]{margin:-.5rem;transform:scale(.75)}[tuiChip]:where(*[data-tui-version="5.4.0"])[data-size=xs]{--t-padding: 0 .375rem;--t-size: var(--tui-height-xs);border-radius:var(--tui-radius-xs)}[tuiChip]:where(*[data-tui-version="5.4.0"])[data-size=xs]>[tuiIconButton]{margin:-.375rem}[tuiChip]:where(*[data-tui-version="5.4.0"])[data-size=m]{--t-margin: -.375rem;--t-icon-size: 1.5rem;--t-padding: 0 1rem;--t-size: var(--tui-height-m);font:var(--tui-typography-body-m)}[tuiChip]:where(*[data-tui-version="5.4.0"])[data-size=m]>[tuiIconButton]{margin:-.75rem}[tuiChip]:where(*[data-tui-version="5.4.0"])[data-size=m]>[tuiBadge]{margin-inline-start:-.375rem}[tuiChip]:where(*[data-tui-version="5.4.0"])>img,[tuiChip]:where(*[data-tui-version="5.4.0"]) [tuiAvatar]{inline-size:1.5rem;margin-inline-start:-.375rem}[tuiChip]:where(*[data-tui-version="5.4.0"])>[tuiFade]:first-of-type{flex:1 0 30%;max-inline-size:fit-content}[tuiChip]:where(*[data-tui-version="5.4.0"])>[tuiFade]:last-of-type{flex:0 1 auto}[tuiChip]:where(*[data-tui-version="5.4.0"])>input[tuiChip]{position:absolute;inset-block-start:0;inset-inline-start:0;inline-size:100%;block-size:100%;margin:0}[tuiChip]:where(*[data-tui-version="5.4.0"])>input[tuiChip][type=checkbox],[tuiChip]:where(*[data-tui-version="5.4.0"])>input[tuiChip][type=radio]{z-index:-1}input[tuiChip]:where(*[data-tui-version="5.4.0"]):is(a,button,select,textarea,input,label,.tui-interactive):not(:disabled){cursor:text}\n'],
  encapsulation: 2,
  changeDetection: 0
});
...
_TuiInputChipDirective.\u0275dir = /* @__PURE__ */ \u0275\u0275defineDirective({
  ...
  hostBindings: function TuiInputChipDirective_HostBindings(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275listener("keydown.enter.prevent", function TuiInputChipDirective_keydown_enter_prevent_HostBindingHandler() {
        return ctx.onEnter();
...
_TuiSliderComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({
  ...
  hostBindings: function TuiSliderComponent_HostBindings(rf, ctx) {
    ...
    if (rf & 2) {
      \u0275\u0275styleProp("--tui-ticks-gradient", ctx.ticksGradient())("--tui-slider-fill-ratio", ctx.valueRatio);
    }
  },
  inputs: {
    segments: [1, "segments"]
...
_TuiSliderKeyStepsBase.\u0275dir = /* @__PURE__ */ \u0275\u0275defineDirective({
  ...
  hostBindings: function TuiSliderKeyStepsBase_HostBindings(rf, ctx) {
    if (rf & 2) {
      \u0275\u0275attribute("min", ctx.transformer() ? 0 : ctx.slider == null ? null : ctx.slider.min)("step", ctx.transformer() ? 1 : ctx.step())("max", ctx.transformer() ? ctx.totalSteps() : ctx.slider == null ? null : ctx.slider.max)("aria-valuemin", ctx.min())("aria-valuemax", ctx.max())("aria-valuenow", ctx.controlValue());
    }
  },
  inputs: {
    step: [1, "step"],
...
_TuiSliderKeySteps.\u0275dir = /* @__PURE__ */ \u0275\u0275defineDirective({
  ...
  hostBindings: function TuiSliderKeySteps_HostBindings(rf, ctx) {
    ...
    if (rf & 2) {
      \u0275\u0275hostProperty("value", ctx.base.toSliderValue(ctx.value()))("disabled", ctx.disabled());
    }
  },
  inputs: {
    keySteps: "keySteps"
...
_TuiInputNumberStepButtons.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({
  ...
  hostBindings: function TuiInputNumberStepButtons_HostBindings(rf, ctx) {
    if (rf & 2) {
      \u0275\u0275styleProp("display", "contents")("border-radius", "inherit");
    }
  },
  ...
  styles: ['tui-textfield:where(*[data-tui-version="5.4.0"]) .t-input-number-buttons.t-input-number-buttons{position:absolute;display:flex;inset-inline-end:0;block-size:var(--t-height);flex-direction:column;gap:.125rem;border-radius:inherit}tui-textfield:where(*[data-tui-version="5.4.0"]) .t-input-number-buttons.t-input-number-buttons>*{flex:1 1 0;border-radius:0}tui-textfield:where(*[data-tui-version="5.4.0"]) .t-input-number-buttons.t-input-number-buttons>*:first-child{border-top-right-radius:inherit}tui-textfield:where(*[data-tui-version="5.4.0"]) .t-input-number-buttons.t-input-number-buttons>*:last-child{border-bottom-right-radius:inherit}[dir=rtl] tui-textfield:where(*[data-tui-version="5.4.0"]) .t-input-number-buttons.t-input-number-buttons>*:first-child{border-radius:0;border-top-left-radius:inherit}[dir=rtl] tui-textfield:where(*[data-tui-version="5.4.0"]) .t-input-number-buttons.t-input-number-buttons>*:last-child{border-radius:0;border-bottom-left-radius:inherit}tui-textfield:where(*[data-tui-version="5.4.0"])[data-size=l]{--t-input-number-offset-end: calc(var(--tui-height-m) + .125rem)}tui-textfield:where(*[data-tui-version="5.4.0"])[data-size=l] .t-input-number-buttons.t-input-number-buttons>*{inline-size:var(--tui-height-m)}tui-textfield:where(*[data-tui-version="5.4.0"])[data-size=m]{--t-input-number-offset-end: calc(var(--tui-height-s) + .125rem)}tui-textfield:where(*[data-tui-version="5.4.0"])[data-size=s]{--t-input-number-offset-end: calc(2 * var(--tui-height-s) + .25rem)}tui-textfield:where(*[data-tui-version="5.4.0"])[data-size=s] .t-input-number-buttons.t-input-number-buttons{flex-direction:row-reverse}tui-textfield:where(*[data-tui-version="5.4.0"])[data-size=s] .t-input-number-buttons.t-input-number-buttons>*:first-child{border-top-right-radius:inherit;border-bottom-right-radius:inherit}tui-textfield:where(*[data-tui-version="5.4.0"])[data-size=s] .t-input-number-buttons.t-input-number-buttons>*:last-child{border-radius:0}[tuiInputNumber]._with-buttons:where(*[data-tui-version="5.4.0"]){border-top-right-radius:0;border-bottom-right-radius:0}[dir=rtl] [tuiInputNumber]._with-buttons:where(*[data-tui-version="5.4.0"]){border-radius:inherit;border-top-left-radius:0;border-bottom-left-radius:0}[tuiInputNumber]._with-buttons:where(*[data-tui-version="5.4.0"]),[data-tui-version="5.4.0"] [tuiInputNumber]._with-buttons~.t-template{inline-size:calc(100% - var(--t-input-number-offset-end));margin-inline-end:var(--t-input-number-offset-end)}[tuiInputNumber]:where(*[data-tui-version="5.4.0"])._with-buttons~.t-content{margin-inline-end:var(--t-input-number-offset-end)}\n'],
  encapsulation: 2,
  changeDetection: 0
});
...
var _TuiInputNumberStep = class _TuiInputNumberStep {
  ...
  onStep(step) {
    ...
    const updated = typeof current === "bigint" ? current + BigInt(step) : tuiSum(current, Number(step));
...
_TuiGroup.\u0275dir = /* @__PURE__ */ \u0275\u0275defineDirective({
  ...
  hostAttrs: ["tuiGroup", "", "data-tui-version", "5.4.0"],
  hostVars: 12,
...
//# sourceMappingURL=chunk-O2R5TA2P.js.map
