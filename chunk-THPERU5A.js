...
function Example_ng_container_13_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r0.toMarkdown(ctx_r0.control.value));
  }
}
var Example = (() => {
  var _a;
  let _instanceExtraInitializers = [];
  let _toMarkdown_decorators;
  return _a = class {
    constructor() {
      this.builtInTools = (__runInitializers(this, _instanceExtraInitializers), [
        TuiEditorTool.Undo,
        TuiEditorTool.Img,
        TuiEditorTool.Link,
    ...
    _toMarkdown_decorators = [tuiPure];
    __esDecorate(_a, null, _toMarkdown_decorators, { kind: "method", name: "toMarkdown", static: false, private: false, access: { has: (obj) => "toMarkdown" in obj, get: (obj) => obj.toMarkdown }, metadata: _metadata }, null, _instanceExtraInitializers);
    if (_metadata) Object.defineProperty(_a, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
  })(), _a.\u0275fac = function Example_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _a)();
  }, _a.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _a, selectors: [["ng-component"]], features: [\u0275\u0275ProvidersFeature([
    ...
    if (rf & 1) {
      ...
      \u0275\u0275template(13, Example_ng_container_13_Template, 3, 1, "ng-container", 3);
      \u0275\u0275elementEnd()();
    }
    if (rf & 2) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(Example, { className: "Example", filePath: "projects/demo/src/app/pages/markdown/examples/1/index.ts", lineNumber: 52 });
})();
export {
...
*/
//# sourceMappingURL=chunk-THPERU5A.js.map
