...
var TuiDetailsExtension = Details.extend({
  addOptions() {
  ...
  addCommands() {
    return __spreadProps(__spreadValues({}, this.parent?.()), {
      ...
      unsetDetails: () => ({ state, dispatch }) => tuiDeleteNode(state, dispatch, this.name),
...
var TuiSummary = TuiDetailsSummary;
...
//# sourceMappingURL=chunk-3ZVYWLQ5.js.map
