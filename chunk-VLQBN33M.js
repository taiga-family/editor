...
var DOMPURIFY = new InjectionToken("[DOMPURIFY]: Configured DOMPurify instance", {
  providedIn: "root",
  factory: () => {
    const instance = purify(inject(DOCUMENT).defaultView);
    const addHook = instance.addHook.bind(instance);
...
var _NgDompurifySanitizer = class _NgDompurifySanitizer {
  constructor() {
    ...
    this.domPurify = inject(DOMPURIFY);
  }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(Example, { className: "Example", filePath: "projects/demo/src/app/pages/sanitize/examples/1/index.ts", lineNumber: 34 });
})();
export {
  Example as default
};
...
*/
//# sourceMappingURL=chunk-VLQBN33M.js.map
