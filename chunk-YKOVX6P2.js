...
// projects/demo/src/app/pages/options/examples/1/index.ts
...
var _Example = class _Example {
  constructor() {
    ...
    this.control = new FormControl("test text\n\rtest text 2");
  }
};
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(Example, { className: "Example", filePath: "projects/demo/src/app/pages/options/examples/1/index.ts", lineNumber: 31 });
})();
export {
  Example as default
};
//# sourceMappingURL=chunk-YKOVX6P2.js.map
