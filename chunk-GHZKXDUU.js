...
function TuiPreviewComponent_Conditional_12_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 8);
    \u0275\u0275listener("click", function TuiPreviewComponent_Conditional_12_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r3);
...
function TuiPreviewComponent_Conditional_13_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(1, "async");
    \u0275\u0275listener("reset", function TuiPreviewComponent_Conditional_13_Template_tui_preview_zoom_reset_0_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.reset());
    })("valueChange", function TuiPreviewComponent_Conditional_13_Template_tui_preview_zoom_valueChange_0_listener($event) {
      \u0275\u0275restoreView(_r5);
      const ctx_r3 = \u0275\u0275nextContext();
...
_TuiPreviewDialog.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({
  ...
  styles: ['tui-preview-dialog:where(*[data-tui-version="5.18.0"]){inline-size:100%;block-size:100%;overflow:hidden}tui-preview-dialog:where(*[data-tui-version="5.18.0"]).tui-enter,tui-preview-dialog:where(*[data-tui-version="5.18.0"]).tui-leave{animation-name:tuiFade,tuiSlide}[tuiAppearance][data-appearance=preview-action]:where(*[data-tui-version="5.18.0"]){background:#686868f5;color:#fff}@media(hover:hover)and (pointer:fine){[tuiAppearance][data-appearance=preview-action]:where(*[data-tui-version="5.18.0"]):is(a,button,select,textarea,input,label,.tui-interactive):not(:disabled):hover:not([data-state]){background:#9f9f9fdb}}[tuiAppearance][data-appearance=preview-action]:where(*[data-tui-version="5.18.0"])[data-state=hover]{background:#9f9f9fdb}[tuiAppearance][data-appearance=preview-action]:where(*[data-tui-version="5.18.0"]):is(a,button,select,textarea,input,label,.tui-interactive):not(:disabled):active:not([data-state]){background:#9f9f9fbf}[tuiAppearance][data-appearance=preview-action]:where(*[data-tui-version="5.18.0"])[data-state=active]{background:#9f9f9fbf}\n'],
  encapsulation: 2,
  changeDetection: 0
});
...
var _TuiPreviewComponent = class _TuiPreviewComponent {
  constructor() {
    ...
    this.transform = toSignal(combineLatest([this.coordinates$.pipe(map(([x, y]) => `${tuiPx(x)}, ${tuiPx(y)}`)), this.zoom$, this.rotation$]).pipe(map(([translate, zoom, rotation]) => `translate(${translate}) scale(${zoom}) rotate(${rotation}deg)`)));
  ...
  onMutation(target, [event]) {
    if (event?.target.isSameNode(target) || event?.target.parentNode?.isSameNode(target) && event.type === "attributes") {
  ...
  onResize({
    ...
    this.minZoom = this.calculateMinZoom(clientHeight, clientWidth, this.el.clientHeight, this.el.clientWidth);
...
_TuiPreviewComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({
  ...
  decls: 14,
  vars: 14,
  consts: [["contentWrapper", ""], ["attributeFilter", "src", "childList", "", "subtree", "", 1, "t-wrapper", 3, "resize", "tuiPan", "tuiZoom", "waMutationObserver"], [1, "t-header"], [1, "t-title"], [1, "t-actions"], [1, "t-footer"], ["tuiHintAppearance", "floating", "tuiHintDescribe", "", "tuiHintDirection", "top-end", "tuiIconButton", "", "tuiPreviewAction", "", "type", "button", 1, "t-rotate-button", 3, "iconStart", "tuiHint"], [3, "min", "value"], ["tuiHintAppearance", "floating", "tuiHintDescribe", "", "tuiHintDirection", "top-end", "tuiIconButton", "", "tuiPreviewAction", "", "type", "button", 1, "t-rotate-button", 3, "click", "iconStart", "tuiHint"], [3, "reset", "valueChange", "min", "value"]],
  template: function TuiPreviewComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275pipe(2, "async");
      \u0275\u0275pipe(3, "async");
      \u0275\u0275listener("resize", function TuiPreviewComponent_Template_section_resize_0_listener() {
        \u0275\u0275restoreView(_r1);
        const contentWrapper_r2 = \u0275\u0275reference(1);
        return \u0275\u0275resetView(ctx.onResize(contentWrapper_r2));
      })("tuiPan", function TuiPreviewComponent_Template_section_tuiPan_0_listener($event) {
        \u0275\u0275restoreView(_r1);
      ...
      })("waMutationObserver", function TuiPreviewComponent_Template_section_waMutationObserver_0_listener($event) {
        \u0275\u0275restoreView(_r1);
        const contentWrapper_r2 = \u0275\u0275reference(1);
        return \u0275\u0275resetView(ctx.onMutation(contentWrapper_r2, $event));
      });
      \u0275\u0275projection(4);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(5, "header", 2)(6, "div", 3);
      \u0275\u0275projection(7, 1);
      \u0275\u0275elementEnd();
      \u0275\u0275projection(8, 2);
      ...
      \u0275\u0275projection(10, 3);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(11, "footer", 5);
      \u0275\u0275template(12, TuiPreviewComponent_Conditional_12_Template, 1, 2, "button", 6)(13, TuiPreviewComponent_Conditional_13_Template, 2, 4, "tui-preview-zoom", 7);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      \u0275\u0275styleProp("cursor", \u0275\u0275pipeBind1(2, 10, ctx.cursor$))("transform", ctx.transform());
      \u0275\u0275classProp("t-not-interactive-content", ctx.zoomable())("t-transitive", \u0275\u0275pipeBind1(3, 12, ctx.transitioned$));
      \u0275\u0275advance(12);
      \u0275\u0275conditional(ctx.rotatable() ? 12 : -1);
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.zoomable() ? 13 : -1);
    }
  },
  dependencies: [AsyncPipe, TuiButton, TuiHintDirective, TuiHintDescribe, TuiPan, TuiPreviewAction, TuiPreviewZoom, TuiZoom, WaMutationObserver],
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(TuiPreviewComponent, [{
    ...
    args: [{
      ...
      imports: [AsyncPipe, TuiButton, TuiHint, TuiPan, TuiPreviewAction, TuiPreviewZoom, TuiZoom, WaMutationObserver],
      changeDetection: ChangeDetectionStrategy.OnPush,
...
//# sourceMappingURL=chunk-GHZKXDUU.js.map
