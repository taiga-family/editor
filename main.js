  ...
  },
  {
    ...
    subPages: [
      ...
      },
      {
        section: "Documentation",
        title: "Image as link",
        keywords: "editor, image link, linked image, href, target, wysiwyg, \u0440\u0435\u0434\u0430\u043A\u0442\u043E\u0440, \u043A\u0430\u0440\u0442\u0438\u043D\u043A\u0430, \u0441\u0441\u044B\u043B\u043A\u0430, html, rich, text",
...
var routes = [
  tuiProvideRoutePageTab({
    ...
    loadComponent: async () => import("./chunk-M56AJRPJ.js"),
    title: "Getting started"
  }),
  tuiProvideRoutePageTab({
    path: TuiDemoPath.StarterKit,
    loadComponent: async () => import("./chunk-7F6LESWL.js"),
    title: "StarterKit"
  }),
  tuiProvideRoutePageTab({
    path: TuiDemoPath.Options,
    loadComponent: async () => import("./chunk-QZM4RI2U.js"),
    title: "ParseOptions"
  }),
  tuiProvideRoutePageTab({
    path: TuiDemoPath.Sanitize,
    loadComponent: async () => import("./chunk-3XEB6KOP.js"),
    title: "Sanitize"
  }),
  tuiProvideRoutePageTab({
    path: TuiDemoPath.Font,
    loadComponent: async () => import("./chunk-DHQXNGFM.js"),
    title: "Font"
  }),
  tuiProvideRoutePageTab({
    path: TuiDemoPath.Anchors,
    loadComponent: async () => import("./chunk-32APAQWX.js"),
    title: "Anchors"
  }),
  tuiProvideRoutePageTab({
    path: TuiDemoPath.Appearance,
    loadComponent: async () => import("./chunk-DOLFSQ7B.js"),
    title: "Appearance"
  }),
  tuiProvideRoutePageTab({
    path: TuiDemoPath.Checkbox,
    loadComponent: async () => import("./chunk-Y6GMSV5V.js"),
    title: "Checkbox"
  }),
  tuiProvideRoutePageTab({
    path: TuiDemoPath.Mention,
    loadComponent: async () => import("./chunk-KEOEQBN6.js"),
    title: "Mention"
  }),
  tuiProvideRoutePageTab({
    path: TuiDemoPath.Details,
    loadComponent: async () => import("./chunk-4PD5LF2O.js"),
    title: "Details"
  }),
  tuiProvideRoutePageTab({
    path: TuiDemoPath.Dialog,
    loadComponent: async () => import("./chunk-7OGMW2YH.js"),
    title: "Dialog"
  }),
  tuiProvideRoutePageTab({
    path: TuiDemoPath.CharacterCounter,
    loadComponent: async () => import("./chunk-QZTHHZI2.js"),
    title: "Character counter"
  }),
  tuiProvideRoutePageTab({
    path: TuiDemoPath.SlashCommand,
    loadComponent: async () => import("./chunk-3AE2ASZ5.js"),
    title: "Slash commands"
  }),
  tuiProvideRoutePageTab({
    path: TuiDemoPath.Focus,
    loadComponent: async () => import("./chunk-ELKCOUKP.js"),
    title: "Focus"
  }),
  tuiProvideRoutePageTab({
    path: TuiDemoPath.Groups,
    loadComponent: async () => import("./chunk-MCHERDGE.js"),
    title: "Groups"
  }),
  tuiProvideRoutePageTab({
    path: TuiDemoPath.TableOfContents,
    loadComponent: async () => import("./chunk-HCUYA2KW.js"),
    title: "Table of Contents"
  }),
  tuiProvideRoutePageTab({
    path: TuiDemoPath.UploadFiles,
    loadComponent: async () => import("./chunk-WGP23ZMF.js"),
    title: "Upload files"
  }),
  tuiProvideRoutePageTab({
    path: TuiDemoPath.PasteEmojiTool,
    loadComponent: async () => import("./chunk-3B76RQLI.js"),
    title: "Editor \u2014 Paste emoji custom tool"
  }),
  tuiProvideRoutePageTab({
    path: TuiDemoPath.Span,
    loadComponent: async () => import("./chunk-FZFIUWM6.js"),
    title: "Editor \u2014 span thread tool"
  }),
  tuiProvideRoutePageTab({
    path: TuiDemoPath.ColorPickerTool,
    loadComponent: async () => import("./chunk-PF2PRT7L.js"),
    title: "Editor \u2014 Color picker custom tool"
  }),
  tuiProvideRoutePageTab({
    path: TuiDemoPath.PasteImageTool,
    loadComponent: async () => import("./chunk-F7N774UN.js"),
  ...
  tuiProvideRoutePageTab({
    ...
    loadComponent: async () => import("./chunk-TIM3AGXK.js"),
    title: "Editor \u2014 Highlight text"
  }),
  tuiProvideRoutePageTab({
    path: TuiDemoPath.ProcessingLegacyHtml,
    loadComponent: async () => import("./chunk-LLF5U3XC.js"),
    title: "Editor \u2014 Legacy html"
  }),
  tuiProvideRoutePageTab({
    path: TuiDemoPath.ProcessingCleanupHtml,
    loadComponent: async () => import("./chunk-Z4HZTA54.js"),
    title: "Editor \u2014 Cleanup html"
  }),
  tuiProvideRoutePageTab({
    path: TuiDemoPath.ClipboardPaste,
    loadComponent: async () => import("./chunk-2YNEZINT.js"),
    title: "Editor \u2014 Clipboard paste"
  }),
  tuiProvideRoutePageTab({
    path: TuiDemoPath.ProcessingMarkdown,
    loadComponent: async () => import("./chunk-ZGG5VHJJ.js"),
    title: "Editor \u2014 Markdown"
  }),
  tuiProvideRoutePageTab({
    path: TuiDemoPath.ProcessingMarkdownExtension,
    loadComponent: async () => import("./chunk-QLAWSHLO.js"),
    title: "Editor \u2014 Markdown"
  }),
  tuiProvideRoutePageTab({
    path: TuiDemoPath.HighlightCode,
    loadComponent: async () => import("./chunk-3DFB7DAC.js"),
    title: "Editor \u2014 Highlight code"
  }),
  tuiProvideRoutePageTab({
    path: TuiDemoPath.ImagesResizable,
    loadComponent: async () => import("./chunk-6J2BWRGV.js"),
    title: "Editor  \u2014 Resizable images"
  }),
  tuiProvideRoutePageTab({
    path: TuiDemoPath.ImagesLink,
    loadComponent: async () => import("./chunk-W5WIKNEE.js"),
    title: "Editor  \u2014 Image as link"
  }),
  tuiProvideRoutePageTab({
    path: TuiDemoPath.ImagesPreview,
    loadComponent: async () => import("./chunk-K5OSMJMX.js"),
    title: "Editor  \u2014 Preview images"
  }),
  tuiProvideRoutePageTab({
    path: TuiDemoPath.UploadImages,
    loadComponent: async () => import("./chunk-72W6HJ2O.js"),
    title: "Editor \u2014 Upload images"
  }),
  tuiProvideRoutePageTab({
    path: TuiDemoPath.EmbedYoutube,
    loadComponent: async () => import("./chunk-CFHJMYXN.js"),
    title: "Editor \u2014 YouTube"
  }),
  tuiProvideRoutePageTab({
    path: TuiDemoPath.EmbedIframe,
    loadComponent: async () => import("./chunk-X73PXKCE.js"),
    title: "Editor \u2014 Iframe"
  }),
  tuiProvideRoutePageTab({
    path: TuiDemoPath.EmbedHtml5,
    loadComponent: async () => import("./chunk-JWDFSV4L.js"),
    title: "Editor \u2014 HTML5"
  }),
  tuiProvideRoutePageTab({
    path: TuiDemoPath.EmbedPDF,
    loadComponent: async () => import("./chunk-T3HCGWXI.js"),
    title: "Editor \u2014 PDF"
  }),
  tuiProvideRoutePageTab({
    path: TuiDemoPath.ToolbarBottom,
    loadComponent: async () => import("./chunk-P37KYOYU.js"),
    title: "Editor \u2014 Toolbar"
  }),
  tuiProvideRoutePageTab({
    path: TuiDemoPath.ToolbarFloating,
    loadComponent: async () => import("./chunk-LYSVPTXW.js"),
    title: "Editor \u2014 Toolbar"
  }),
  tuiProvideRoutePageTab({
    path: TuiDemoPath.ToolbarShared,
    loadComponent: async () => import("./chunk-FJU4CGKJ.js"),
    title: "Editor \u2014 Toolbar"
  }),
  tuiProvideRoutePageTab({
    path: TuiDemoPath.ToolbarCustom,
    loadComponent: async () => import("./chunk-EQXZMF75.js"),
    title: "Editor \u2014 Toolbar"
  }),
  {
    path: "**",
...
_TuiLogo.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _TuiLogo, selectors: [["logo"]], decls: 10, vars: 0, consts: [["routerLink", "/", "tuiLink", "", 1, "logo-link"], [1, "logo-name"], ["fill", "none", "height", "29", "viewBox", "0 0 178 29", "width", "178", "xmlns", "http://www.w3.org/2000/svg"], ["clip-path", "url(#clip0_1_11)"], ["d", "M44.4439 23.826H48.3769V9.72702H54.0419V6.62302H38.7528V9.72702H44.4439V23.826ZM54.8708 23.826H58.7009V10.891H54.8708V23.826ZM54.6909 9.18402H58.8549V6.62302H54.6898V9.18302L54.6909 9.18402ZM69.8498 24.24C74.0658 24.24 75.7999 21.032 75.7999 17.359C75.7999 13.633 74.0658 10.477 69.8498 10.477C67.6248 10.477 66.1238 11.331 65.2188 12.806V10.89H61.3889V29H65.2188V21.886C66.1238 23.36 67.6258 24.24 69.8498 24.24ZM65.2188 17.359C65.2188 14.72 66.2528 13.479 68.6588 13.479C71.0908 13.479 71.9708 14.669 71.9708 17.359C71.9708 20.023 71.0908 21.239 68.6588 21.239C66.2528 21.239 65.2188 19.997 65.2188 17.359ZM83.6329 23.826H86.0648V20.773H82.7019V13.79H86.4268V10.89H82.7019V7.81302H80.7618L79.1828 10.865L76.5188 11.952V13.789H78.8728V19.169C78.8728 22.249 79.9589 23.826 83.6329 23.826ZM93.5448 24.24C95.7698 24.24 97.2188 23.36 98.0718 21.886V23.826H101.901V10.891H98.0718V12.806C97.2188 11.331 95.7698 10.477 93.5448 10.477C89.2758 10.477 87.7248 13.607 87.7248 17.359C87.7248 21.032 89.2768 24.24 93.5448 24.24ZM91.5268 17.359C91.5268 14.591 92.4068 13.479 94.7348 13.479C96.9848 13.479 98.0718 14.539 98.0718 17.359C98.0718 20.153 96.9858 21.239 94.7348 21.239C92.4068 21.239 91.5268 20.101 91.5268 17.359ZM113.1 24.24C117.317 24.24 119.05 21.032 119.05 17.359C119.05 13.633 117.317 10.477 113.1 10.477C110.875 10.477 109.375 11.331 108.469 12.806V10.89H104.641V29H108.469V21.886C109.375 23.36 110.875 24.24 113.1 24.24ZM108.469 17.359C108.469 14.72 109.504 13.479 111.91 13.479C114.342 13.479 115.221 14.669 115.221 17.359C115.221 20.023 114.342 21.239 111.91 21.239C109.504 21.239 108.469 19.997 108.469 17.359ZM22.3049 4.04302C19.8698 2.06941 16.8293 0.994798 13.6948 1.00002C10.4348 1.00002 7.43885 2.14002 5.08685 4.04302H22.3049ZM0.779851 10.13C1.15952 9.05597 1.67217 8.03369 2.30585 7.08702H25.0849C25.7129 8.02602 26.2289 9.04702 26.6119 10.13H0.779851ZM0.0838507 16.217C-0.0279502 15.2058 -0.0279502 14.1853 0.0838507 13.174H27.3079C27.4198 14.1853 27.4198 15.2058 27.3079 16.217H0.0838507ZM2.30585 22.304C1.67217 21.3574 1.15952 20.3351 0.779851 19.261H26.6129C26.2329 20.3351 25.7199 21.3574 25.0859 22.304H2.30585ZM22.3049 25.348C19.8698 27.3216 16.8293 28.3962 13.6948 28.391C10.4348 28.391 7.43885 27.251 5.08685 25.348H22.3049Z", "fill", "currentColor"], ["clip-rule", "evenodd", "d", "M178 28.5023L162 1L146 28.5023H155.714L159.762 22.2984H156.811L162 14.1507L167.189 22.2984H164.239L168.287 28.5023H178Z", "fill", "#FF7043", "fill-rule", "evenodd"], ["d", "M133.955 21.8068V10.5568H135.864V21.8068H133.955ZM129.284 17.1364V15.2273H140.534V17.1364H129.284Z", "fill", "currentColor"], ["id", "clip0_1_11"], ["fill", "white", "height", "28", "transform", "translate(0 1)", "width", "120"]], template: function TuiLogo_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(7, "defs")(8, "clipPath", 7);
    \u0275\u0275element(9, "rect", 8);
    \u0275\u0275elementEnd()()()()();
  }
}, dependencies: [TuiLink], styles: ['\n\n[_nghost-%COMP%] {\n  display: flex;\n  align-items: center;\n}\n[_nghost-%COMP%]   tui-root._mobile[_nghost-%COMP%], tui-root._mobile   [_nghost-%COMP%] {\n  font-size: 0;\n}\n.logo-link[_ngcontent-%COMP%] {\n  display: flex;\n}\n.logo-name[_ngcontent-%COMP%] {\n  display: flex;\n  color: var(--tui-text-primary);\n}\n.logo-icon[_ngcontent-%COMP%] {\n  min-inline-size: 11.25rem;\n  min-block-size: 1.875rem;\n  color: #eb5a3d;\n}\n.logo-icon[tuiTheme="dark"][_nghost-%COMP%]   .logo-icon[_ngcontent-%COMP%], [tuiTheme="dark"]   [_nghost-%COMP%]   .logo-icon[_ngcontent-%COMP%] {\n  color: #fff;\n}\n.logo[_ngcontent-%COMP%] {\n  margin-inline-end: 0.625rem;\n}\n.by[_ngcontent-%COMP%] {\n  margin-inline-start: 0.875rem;\n}\ntui-root._mobile[_nghost-%COMP%]   .by[_ngcontent-%COMP%], tui-root._mobile   [_nghost-%COMP%]   .by[_ngcontent-%COMP%] {\n  display: none;\n}\n/*# sourceMappingURL=index.css.map */'], changeDetection: 0 });
var TuiLogo = _TuiLogo;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(TuiLogo, [{
    type: Component,
    args: [{ selector: "logo", imports: [TuiLink], changeDetection: ChangeDetectionStrategy.OnPush, template: '<a\n    routerLink="/"\n    tuiLink\n    class="logo-link"\n>\n    <span class="logo-name">\n        <svg\n            fill="none"\n            height="29"\n            viewBox="0 0 178 29"\n            width="178"\n            xmlns="http://www.w3.org/2000/svg"\n        >\n            <g clip-path="url(#clip0_1_11)">\n                <path\n                    d="M44.4439 23.826H48.3769V9.72702H54.0419V6.62302H38.7528V9.72702H44.4439V23.826ZM54.8708 23.826H58.7009V10.891H54.8708V23.826ZM54.6909 9.18402H58.8549V6.62302H54.6898V9.18302L54.6909 9.18402ZM69.8498 24.24C74.0658 24.24 75.7999 21.032 75.7999 17.359C75.7999 13.633 74.0658 10.477 69.8498 10.477C67.6248 10.477 66.1238 11.331 65.2188 12.806V10.89H61.3889V29H65.2188V21.886C66.1238 23.36 67.6258 24.24 69.8498 24.24ZM65.2188 17.359C65.2188 14.72 66.2528 13.479 68.6588 13.479C71.0908 13.479 71.9708 14.669 71.9708 17.359C71.9708 20.023 71.0908 21.239 68.6588 21.239C66.2528 21.239 65.2188 19.997 65.2188 17.359ZM83.6329 23.826H86.0648V20.773H82.7019V13.79H86.4268V10.89H82.7019V7.81302H80.7618L79.1828 10.865L76.5188 11.952V13.789H78.8728V19.169C78.8728 22.249 79.9589 23.826 83.6329 23.826ZM93.5448 24.24C95.7698 24.24 97.2188 23.36 98.0718 21.886V23.826H101.901V10.891H98.0718V12.806C97.2188 11.331 95.7698 10.477 93.5448 10.477C89.2758 10.477 87.7248 13.607 87.7248 17.359C87.7248 21.032 89.2768 24.24 93.5448 24.24ZM91.5268 17.359C91.5268 14.591 92.4068 13.479 94.7348 13.479C96.9848 13.479 98.0718 14.539 98.0718 17.359C98.0718 20.153 96.9858 21.239 94.7348 21.239C92.4068 21.239 91.5268 20.101 91.5268 17.359ZM113.1 24.24C117.317 24.24 119.05 21.032 119.05 17.359C119.05 13.633 117.317 10.477 113.1 10.477C110.875 10.477 109.375 11.331 108.469 12.806V10.89H104.641V29H108.469V21.886C109.375 23.36 110.875 24.24 113.1 24.24ZM108.469 17.359C108.469 14.72 109.504 13.479 111.91 13.479C114.342 13.479 115.221 14.669 115.221 17.359C115.221 20.023 114.342 21.239 111.91 21.239C109.504 21.239 108.469 19.997 108.469 17.359ZM22.3049 4.04302C19.8698 2.06941 16.8293 0.994798 13.6948 1.00002C10.4348 1.00002 7.43885 2.14002 5.08685 4.04302H22.3049ZM0.779851 10.13C1.15952 9.05597 1.67217 8.03369 2.30585 7.08702H25.0849C25.7129 8.02602 26.2289 9.04702 26.6119 10.13H0.779851ZM0.0838507 16.217C-0.0279502 15.2058 -0.0279502 14.1853 0.0838507 13.174H27.3079C27.4198 14.1853 27.4198 15.2058 27.3079 16.217H0.0838507ZM2.30585 22.304C1.67217 21.3574 1.15952 20.3351 0.779851 19.261H26.6129C26.2329 20.3351 25.7199 21.3574 25.0859 22.304H2.30585ZM22.3049 25.348C19.8698 27.3216 16.8293 28.3962 13.6948 28.391C10.4348 28.391 7.43885 27.251 5.08685 25.348H22.3049Z"\n                    fill="currentColor"\n                />\n            </g>\n            <path\n                clip-rule="evenodd"\n                d="M178 28.5023L162 1L146 28.5023H155.714L159.762 22.2984H156.811L162 14.1507L167.189 22.2984H164.239L168.287 28.5023H178Z"\n                fill="#FF7043"\n                fill-rule="evenodd"\n            />\n            <path\n                d="M133.955 21.8068V10.5568H135.864V21.8068H133.955ZM129.284 17.1364V15.2273H140.534V17.1364H129.284Z"\n                fill="currentColor"\n            />\n            <defs>\n                <clipPath id="clip0_1_11">\n                    <rect\n                        fill="white"\n                        height="28"\n                        transform="translate(0 1)"\n                        width="120"\n                    />\n                </clipPath>\n            </defs>\n        </svg>\n    </span>\n</a>\n', styles: ['/* projects/demo/src/app/shared/logo/index.less */\n:host {\n  display: flex;\n  align-items: center;\n}\n:host :host-context(tui-root._mobile) {\n  font-size: 0;\n}\n.logo-link {\n  display: flex;\n}\n.logo-name {\n  display: flex;\n  color: var(--tui-text-primary);\n}\n.logo-icon {\n  min-inline-size: 11.25rem;\n  min-block-size: 1.875rem;\n  color: #eb5a3d;\n}\n.logo-icon:host-context([tuiTheme="dark"]) .logo-icon {\n  color: #fff;\n}\n.logo {\n  margin-inline-end: 0.625rem;\n}\n.by {\n  margin-inline-start: 0.875rem;\n}\n:host-context(tui-root._mobile) .by {\n  display: none;\n}\n/*# sourceMappingURL=index.css.map */\n'] }]
  }], null, null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(TuiLogo, { className: "TuiLogo", filePath: "projects/demo/src/app/shared/logo/index.ts", lineNumber: 12 });
})();
...
var appConfig = {
  providers: [
    ...
    provideTaiga(),
    provideHighlightOptions({
      coreLibraryLoader: async () => import("./chunk-WQOZQU4B.js"),
      lineNumbersLoader: async () => import("./chunk-RJJ33DRK.js"),
      languages: {
        typescript: async () => import("./chunk-IHCVTAHO.js"),
        less: async () => import("./chunk-XTJZBEP5.js"),
        xml: async () => import("./chunk-QHRA4IRU.js"),
        bash: async () => import("./chunk-OTUR5SYP.js")
      }
    }),
    {
    ...
    },
    {
      ...
      useValue: (context) => {
        ...
        return context.package.toLowerCase() === "kit" ? `${link}/${context.package.toLowerCase()}/src/lib/editor/${`${context.header[0]?.toLowerCase() ?? ""}${context.header.slice(1)}`.replaceAll(/[A-Z]/g, (m) => `-${m.toLowerCase()}`)}` : null;
      }
    }
  ]
};
