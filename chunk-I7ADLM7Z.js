...
var Example = (() => {
  ...
  return _a = class {
    ...
    provideTuiEditor(() => __async(_a, null, function* () {
      return import("./chunk-24ATC4XT.js").then(({ TuiYoutube }) => TuiYoutube);
    }))
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(Example, { className: "Example", filePath: "projects/demo/src/app/pages/embed/youtube/examples/1/index.ts", lineNumber: 41 });
})();
export {
  __default as default
};
//# sourceMappingURL=chunk-I7ADLM7Z.js.map
