...
}, dependencies: [AsyncPipe, TuiButton, TuiColorSelectorModule, TuiColorSelectorComponent, TuiDropdownOptionsDirective, TuiDropdownDirective, TuiDropdownOpen], styles: ["\n\n[_nghost-%COMP%] {\n  position: relative;\n}\n.t-color-save[_ngcontent-%COMP%] {\n  position: sticky;\n  inset-inline-start: 0;\n  inset-block-end: 0;\n  inline-size: 100%;\n  box-shadow: inset 0 0.0625rem var(--tui-background-neutral-1-hover);\n  background: var(--tui-background-base) !important;\n}\n/*# sourceMappingURL=index.css.map */"], changeDetection: 0 });
var CustomColorPicker = _CustomColorPicker;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(CustomColorPicker, [{
    type: Component,
    args: [{ selector: "custom-color-picker", imports: [AsyncPipe, TuiButton, TuiColorSelectorModule, TuiDropdown], changeDetection: ChangeDetectionStrategy.OnPush, host: { tuiPlateHost: "" }, template: `<div>
    <button
        appearance="icon"
...
//# sourceMappingURL=chunk-WC5MLRL3.js.map
