...
_Example.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _Example, selectors: [["ng-component"]], features: [\u0275\u0275ProvidersFeature([
  provideTuiEditor((injector) => __async(_Example, null, function* () {
    return import("./chunk-GGVS5VAY.js").then(({ tuiCreateImageEditorExtension }) => tuiCreateImageEditorExtension({ injector }).extend(IMAGE_CLIPBOARD_PASTE_EXTENSION));
  }))
...
//# sourceMappingURL=chunk-RVEYBBHV.js.map
