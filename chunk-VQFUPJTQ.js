...
var _TuiTiptapEditorService = class _TuiTiptapEditorService extends AbstractTuiEditor {
  ...
  setImage(src) {
    this.editor?.chain().focus().command(({ commands, state }) => {
      const optionalCommands = commands;
      const setImage = optionalCommands.setEditableImage ?? optionalCommands.setImage;
      if (!setImage) {
        return false;
      }
...
_TuiTiptapEditor.\u0275dir = /* @__PURE__ */ \u0275\u0275defineDirective({ type: _TuiTiptapEditor, selectors: [["", "tuiTiptapEditor", ""]], inputs: { value: [1, "value"], editable: [1, "editable"] }, outputs: { valueChange: "valueChange" } });
...
_TuiInputInline.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({
  ...
  styles: ['tui-input-inline:where(*[data-tui-version="5.18.0"]){position:relative;display:inline-block;white-space:nowrap;box-sizing:border-box}tui-input-inline:where(*[data-tui-version="5.18.0"])>.t-before{padding-inline-end:.02em;margin-inline-start:1px;white-space:pre;visibility:hidden}tui-input-inline:where(*[data-tui-version="5.18.0"])>.t-placeholder{display:inline-block;min-inline-size:1px;margin-inline-start:-1px}tui-input-inline:where(*[data-tui-version="5.18.0"])>input{position:absolute;inset-block-start:0;inset-inline-start:0;background-color:transparent;padding:inherit;font:inherit;color:inherit;box-sizing:border-box;inline-size:100%;block-size:100%;border-width:0;text-align:inherit;letter-spacing:inherit;text-indent:inherit;text-transform:inherit;outline:none}\n'],
  encapsulation: 2,
  changeDetection: 0
});
...
function isValidUrl(url) {
  return /^(?:[a-z]+:\/\/)?(?:(?:[a-z\d][-a-z\d]*\.)+[a-z]{2,}|localhost|(?:\d{1,3}\.){3}\d{1,3})(?::\d+)?(?:\/[-\w%.~+:]*)*(?:\?[-\w%.~+;:&()=]*)?(?:#[-\w]*)?$/iu.test(url);
}
...
function TuiImageEditor_Conditional_7_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("iconStart", ctx_r2.options.icons.imageExtension.align);
    \u0275\u0275advance(2);
    ...
    @if (editor.isEditable) {
        ...
        >
            <button
                ...
                tuiIconButton
                type="button"
                [iconStart]="options.icons.imageExtension.align"
...
var Image = Node.create({
  ...
  addNodeView() {
    ...
    return ({
      ...
      let previousHTMLAttributes = __spreadValues({}, HTMLAttributes);
...
function tuiCreateImageEditorExtension({ injector, draggable }) {
  ...
  return Image.extend({
      ...
      return [
        {
          ...
          getAttrs: (el) => {
            ...
            const href = link?.getAttribute("href") ?? void 0;
            if (!href || !typesafeIsAllowedUri(href)) {
              return false;
            }
            const style = link?.getAttribute("style") ?? el.getAttribute("style");
            return {
              "data-href": href,
              "data-target": link?.getAttribute("target"),
              src: el.getAttribute("src") ?? "",
              style,
              width: el.getAttribute("width") ?? void 0,
    ...
    renderHTML({ HTMLAttributes }) {
      ...
      const { src, width, alt, style, title, draggable: draggable2, "data-href": href, "data-target": target } = attrs;
      return href ? [
        "a",
        mergeAttributes({
      ...
      ] : ["img", mergeAttributes({ src, width, alt, style, title, draggable: draggable2 })];
    },
    addNodeView() {
...
//# sourceMappingURL=chunk-VQFUPJTQ.js.map
