...
_Example.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _Example, selectors: [["ng-component"]], features: [\u0275\u0275ProvidersFeature([
  provideTuiEditor(() => __async(_Example, null, function* () {
    return import("./chunk-NOEJKQKS.js").then(({ tuiCreateGroupExtension }) => tuiCreateGroupExtension({
      draggable: false,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(Example, { className: "Example", filePath: "projects/demo/src/app/pages/groups/examples/3/index.ts", lineNumber: 37 });
})();
export {
  Example as default
};
//# sourceMappingURL=chunk-TGCK5WVJ.js.map
