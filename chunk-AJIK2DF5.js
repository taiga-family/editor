...
var TUI_EDITOR_DEFAULT_OPTIONS = {
  ...
  icons: {
    ...
    imageExtension: {
      ...
      // TODO(v5): rename settings to align
...
// projects/editor/common/hack.ts
var TUI_TIPTAP_WHITESPACE_HACK = `<span style="font-size: 15px">${CHAR_NO_BREAK_SPACE}</span>`;

// projects/editor/common/i18n.ts
var TUI_EDITOR_COLOR_SELECTOR_MODE_NAMES = new InjectionToken(ngDevMode ? "TUI_EDITOR_COLOR_SELECTOR_MODE_NAMES" : "", { factory: () => ["Solid color", "Gradient"] });
...
var LAZY_TIPTAP_EDITOR = new InjectionToken(ngDevMode ? "LAZY_TIPTAP_EDITOR" : "", {
  factory: () => {
    ...
    import("./chunk-OA2KG6ZA.js").then(({ Editor }) => editor$.next(Editor)).catch(() => editor$.complete());
    return editor$;
  }
});
...
//# sourceMappingURL=chunk-AJIK2DF5.js.map
