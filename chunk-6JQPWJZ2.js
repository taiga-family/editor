...
_Example.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _Example, selectors: [["ng-component"]], viewQuery: function Example_Query(rf, ctx) {
  ...
  provideTuiEditor({ image: true }, () => __async(_Example, null, function* () {
    return import("./chunk-VEJYG3ZL.js").then(({ TuiMarkdown }) => TuiMarkdown.configure({
      html: true,
...
])], decls: 4, vars: 5, consts: [[3, "formControl", "tools"], [1, "tui-space_top-5", 3, "ngModelChange", "ngModel"]], template: function Example_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tui-editor", 0);
    \u0275\u0275text(1, " Placeholder\n");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(2, "tui-textarea", 1);
    \u0275\u0275listener("ngModelChange", function Example_Template_tui_textarea_ngModelChange_2_listener($event) {
...
}, dependencies: [FormsModule, NgControlStatus, NgModel, ReactiveFormsModule, FormControlDirective, TuiEditor, TuiTextareaModule, TuiTextareaComponent, TuiTextareaDirective], encapsulation: 2, changeDetection: 0 });
var Example = _Example;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(Example, [{
    type: Component,
    args: [{ imports: [FormsModule, ReactiveFormsModule, TuiEditor, TuiTextareaModule], changeDetection: ChangeDetectionStrategy.OnPush, providers: [
...
//# sourceMappingURL=chunk-6JQPWJZ2.js.map
