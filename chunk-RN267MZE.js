...
_Example.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _Example, selectors: [["ng-component"]], viewQuery: function Example_Query(rf, ctx) {
  ...
  if (rf & 1) {
    \u0275\u0275listener("keydown.arrowUp", function Example_keydown_arrowUp_HostBindingHandler($event) {
      return ctx.down($event, false);
    }, false, \u0275\u0275resolveWindow)("keydown.arrowDown", function Example_keydown_arrowDown_HostBindingHandler($event) {
      return ctx.down($event, true);
    }, false, \u0275\u0275resolveWindow);
  }
}, features: [\u0275\u0275ProvidersFeature([provideTuiEditor()])], decls: 11, vars: 6, consts: [[3, "tuiDropdownOpenChange", "formControl", "tools", "tuiDropdownOpen"], [4, "tuiTextfieldDropdown"], [3, "closeOthers"], [3, "tuiAccordion"], [4, "tuiItem"], ["tuiOption", "", "type", "button"], ["tuiOption", "", "type", "button", 3, "click"], [3, "content"], [1, "code"]], template: function Example_Template(rf, ctx) {
  if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(Example, { className: "Example", filePath: "projects/demo/src/app/pages/slash/examples/1/index.ts", lineNumber: 50 });
})();
export {
  Example as default
};
//# sourceMappingURL=chunk-RN267MZE.js.map
