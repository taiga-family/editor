...
// projects/demo/src/app/pages/markdown/examples/1/make-markdown.ts
var import_showdown = __toESM(require_showdown());
var _MakeMarkdownPipe = class _MakeMarkdownPipe {
  transform(html) {
    return new import_showdown.Converter().makeMarkdown(html?.replaceAll("&lt;", "<").replaceAll("&gt;", ">") ?? "");
  }
};
_MakeMarkdownPipe.\u0275fac = function MakeMarkdownPipe_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _MakeMarkdownPipe)();
};
_MakeMarkdownPipe.\u0275pipe = /* @__PURE__ */ \u0275\u0275definePipe({ name: "makeMarkdown", type: _MakeMarkdownPipe, pure: true });
var MakeMarkdownPipe = _MakeMarkdownPipe;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(MakeMarkdownPipe, [{
    type: Pipe,
    args: [{ name: "makeMarkdown" }]
  }], null, null);
})();

// projects/demo/src/app/pages/markdown/examples/1/index.ts
function Example_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("formControl", ctx_r0.control)("tools", ctx_r0.builtInTools);
  }
}
...
function Example_ng_container_13_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275elementStart(1, "pre", 6);
    \u0275\u0275text(2);
    \u0275\u0275pipe(3, "makeMarkdown");
    \u0275\u0275elementEnd();
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(3, 1, ctx_r0.control.value));
  }
}
var _Example = class _Example {
  ...
  ngOnInit() {
    void tuiRawLoad(import("./chunk-KHLPVT2F.js")).then((data) => this.control.patchValue(data));
  }
};
...
_Example.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _Example, selectors: [["ng-component"]], features: [\u0275\u0275ProvidersFeature([
  ...
  },
  {
    ...
    useValue: new class extends TuiValueTransformer {
      constructor() {
        super(...arguments);
        this.toControlValue = (value) => value;
        this.fromControlValue = (value) => new lib_default().render(value);
      }
    }()
  }
])], decls: 14, vars: 5, consts: [[1, "editor", 3, "formControl", "tools"], [3, "closeOthers"], [3, "tuiAccordion"], [4, "tuiItem"], [3, "content"], [1, "code"], [1, "markdown"]], template: function Example_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, Example_Conditional_0_Template, 2, 2, "tui-editor", 0);
    ...
    \u0275\u0275text(11, "Markdown");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "tui-expand");
    \u0275\u0275template(13, Example_ng_container_13_Template, 4, 3, "ng-container", 3);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    \u0275\u0275conditional(ctx.control ? 0 : -1);
    \u0275\u0275advance();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(Example, [{
    ...
    ], template: '@if (control) {\n    <tui-editor\n        class="editor"\n        [formControl]="control"\n        [tools]="builtInTools"\n    >\n        Placeholder\n    </tui-editor>\n}\n\n<tui-accordion [closeOthers]="false">\n    <button [tuiAccordion]="isE2E">HTML</button>\n    <tui-expand>\n        <ng-container *tuiItem>\n            <tui-editor-socket [content]="control.value" />\n        </ng-container>\n    </tui-expand>\n\n    <button [tuiAccordion]="isE2E">Text</button>\n    <tui-expand>\n        <ng-container *tuiItem>\n            <span class="code">{{ control.value }}</span>\n        </ng-container>\n    </tui-expand>\n\n    <button [tuiAccordion]="isE2E">Markdown</button>\n    <tui-expand>\n        <ng-container *tuiItem>\n            <pre class="markdown">{{ control.value | makeMarkdown }}</pre>\n        </ng-container>\n    </tui-expand>\n</tui-accordion>\n', styles: ["/* projects/demo/src/app/pages/markdown/examples/1/index.less */\n.editor {\n  min-block-size: 30rem;\n}\n.markdown {\n  font-family: monospace;\n  padding: 0.375rem 0.5rem;\n  background: var(--tui-background-base-alt);\n  color: var(--tui-text-secondary);\n  box-shadow: inset 0 -0.125rem var(--tui-background-neutral-1);\n  font-size: 0.875rem;\n  white-space: break-spaces;\n}\n/*# sourceMappingURL=index.css.map */\n"] }]
  }], null, null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(Example, { className: "Example", filePath: "projects/demo/src/app/pages/markdown/examples/1/index.ts", lineNumber: 53 });
})();
export {
  Example as default
};
...
*/
//# sourceMappingURL=chunk-2YRVYSVK.js.map
