...
_Example.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _Example, selectors: [["ng-component"]], viewQuery: function Example_Query(rf, ctx) {
  ...
  provideTuiEditor({ textAlign: { types: ["heading", "paragraph"] } }, () => __async(_Example, null, function* () {
    return import("./chunk-3GKABNXJ.js").then(({ Highlight }) => Highlight.configure({
      multicolor: true,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(Example, [{
    ...
    args: [{ imports: [
      ...
      provideTuiEditor({ textAlign: { types: ["heading", "paragraph"] } }, () => __async(null, null, function* () {
        return import("./chunk-3GKABNXJ.js").then(({ Highlight }) => Highlight.configure({
          multicolor: true,
          HTMLAttributes: { class: "marked" }
        }));
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(Example, { className: "Example", filePath: "projects/demo/src/app/pages/highlight/text/examples/1/index.ts", lineNumber: 37 });
})();
export {
  Example as default
};
//# sourceMappingURL=chunk-XIYSWL2N.js.map
